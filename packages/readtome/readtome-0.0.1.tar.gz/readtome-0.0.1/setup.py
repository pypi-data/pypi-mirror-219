...
setup(
    name='readtome',
    description="CLI to read code via text-to-speech",
    ...
    entry_points="""
    [console_scripts]
    readtome=readtome.cli:cli
    """,
    python_requires=">=0.0.1",
    license='MIT',  # noqa
    author='Josh Winters',
    author_email='josh@winters.codes',
    # Use the URL to the github repo.
    url= 'https://github.com/jbwinters/readtome',
    download_url=(
        f'https://github.com/jbwinters/'
        f'readtome/archive/{version}.tar.gz'
    ),
    keywords=[
