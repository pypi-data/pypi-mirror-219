...
# ///港澳台居民居住证
IdCardType_HKMCTwResidencePermit = b'M'
# ///统一社会信用代码
IdCardType_UniformSocialCreditCode = b'N'
# ///机构成立证明文件
IdCardType_CorporationCertNo = b'O'
# ///其他证件
...
# /////////////////////////////////////////////////////////////////////////
# ///期货单一合约
APIProductClass_FutureSingle = b'1'
# ///期权单一合约
APIProductClass_OptionSingle = b'2'
# ///可交易期货(含期货组合和期货单一合约)
APIProductClass_Futures = b'3'
# ///可交易期权(含期权组合和期权单一合约)
APIProductClass_Options = b'4'
# ///可下单套利组合
APIProductClass_TradingComb = b'5'
# ///可申请的组合（可以申请的组合合约 包含可以交易的合约）
APIProductClass_UnTradingComb = b'6'
# ///所有可以交易合约
APIProductClass_AllTrading = b'7'
# ///所有合约（包含不能交易合约 慎用）
APIProductClass_All = b'8'
...
# /////////////////////////////////////////////////////////////////////////
# ///^\d{8}_zz_\d{4}
CZCEUploadFileName_O = b'O'
# ///^\d{8}成交表
CZCEUploadFileName_T = b'T'
# ///^\d{8}单腿持仓表new
CZCEUploadFileName_P = b'P'
# ///^\d{8}非平仓了结表
CZCEUploadFileName_N = b'N'
# ///^\d{8}平仓表
CZCEUploadFileName_L = b'L'
# ///^\d{8}资金表
CZCEUploadFileName_F = b'F'
# ///^\d{8}组合持仓表
CZCEUploadFileName_C = b'C'
# ///^\d{8}保证金参数表
CZCEUploadFileName_M = b'M'

# /////////////////////////////////////////////////////////////////////////
# ///TFtdcDCEUploadFileNameType是一个大商所结算文件名类型
# /////////////////////////////////////////////////////////////////////////
# ///^\d{8}_dl_\d{3}
DCEUploadFileName_O = b'O'
# ///^\d{8}_成交表
DCEUploadFileName_T = b'T'
# ///^\d{8}_持仓表
DCEUploadFileName_P = b'P'
# ///^\d{8}_资金结算表
DCEUploadFileName_F = b'F'
# ///^\d{8}_优惠组合持仓明细表
DCEUploadFileName_C = b'C'
# ///^\d{8}_持仓明细表
DCEUploadFileName_D = b'D'
# ///^\d{8}_保证金参数表
DCEUploadFileName_M = b'M'
# ///^\d{8}_期权执行表
DCEUploadFileName_S = b'S'

# /////////////////////////////////////////////////////////////////////////
# ///TFtdcSHFEUploadFileNameType是一个上期所结算文件名类型
# /////////////////////////////////////////////////////////////////////////
# ///^\d{4}_\d{8}_\d{8}_DailyFundChg
SHFEUploadFileName_O = b'O'
# ///^\d{4}_\d{8}_\d{8}_Trade
SHFEUploadFileName_T = b'T'
# ///^\d{4}_\d{8}_\d{8}_SettlementDetail
SHFEUploadFileName_P = b'P'
# ///^\d{4}_\d{8}_\d{8}_Capital
SHFEUploadFileName_F = b'F'

# /////////////////////////////////////////////////////////////////////////
# ///TFtdcCFFEXUploadFileNameType是一个中金所结算文件名类型
# /////////////////////////////////////////////////////////////////////////
# ///^\d{4}_SG\d{1}_\d{8}_\d{1}_Trade
CFFEXUploadFileName_T = b'T'
# ///^\d{4}_SG\d{1}_\d{8}_\d{1}_SettlementDetail
CFFEXUploadFileName_P = b'P'
# ///^\d{4}_SG\d{1}_\d{8}_\d{1}_Capital
CFFEXUploadFileName_F = b'F'
# ///^\d{4}_SG\d{1}_\d{8}_\d{1}_OptionExec
CFFEXUploadFileName_S = b'S'
...
# /////////////////////////////////////////////////////////////////////////
# ///直连的投资者
AppType_Investor = b'1'
# ///为每个投资者都创建连接的中继
AppType_InvestorRelay = b'2'
# ///所有投资者共享一个操作员连接的中继
AppType_OperatorRelay = b'3'
# ///未知
AppType_UnKnown = b'4'
...
# /////////////////////////////////////////////////////////////////////////
# ///大宗交易
OTCTradeType_Block = b'0'
# ///期转现
OTCTradeType_EFP = b'1'
...
TradingType_ALL = b'0'
# ///交易
TradingType_TRADE = b'1'
# ///非交易
TradingType_UNTRADE = b'2'
