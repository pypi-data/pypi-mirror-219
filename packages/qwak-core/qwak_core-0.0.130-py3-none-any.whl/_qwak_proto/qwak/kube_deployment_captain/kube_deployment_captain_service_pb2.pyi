...
class BatchFeatureSetV1DeploymentRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["batch_details", b"batch_details", "feature_set_deployment", b"feature_set_deployment"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["batch_details", b"batch_details", "environment_id", b"environment_id", "feature_set_deployment", b"feature_set_deployment"]) -> None: ...
