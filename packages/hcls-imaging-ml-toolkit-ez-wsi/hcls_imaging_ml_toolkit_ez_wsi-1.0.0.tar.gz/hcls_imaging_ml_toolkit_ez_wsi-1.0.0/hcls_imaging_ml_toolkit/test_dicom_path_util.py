...
DATASET_PATH_STR = dicom_path.DicomPathJoin(
    'projects', PROJECT_NAME, 'locations', LOCATION, 'datasets', DATASET_ID
)
STORE_PATH_STR = dicom_path.DicomPathJoin(
    DATASET_PATH_STR, 'dicomStores', STORE_ID
)
DICOMWEB_PATH_STR = dicom_path.DicomPathJoin(STORE_PATH_STR, 'dicomWeb')
STUDY_PATH_STR = dicom_path.DicomPathJoin(
    DICOMWEB_PATH_STR, 'studies', STUDY_UID
)
