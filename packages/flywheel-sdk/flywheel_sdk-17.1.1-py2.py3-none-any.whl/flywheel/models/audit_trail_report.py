...
class AuditTrailReport(object):
    ...
    def __init__(self, id=None, origin=None, project_id=None, subject_ids=None, label=None, status=None, created=None, finished=None, revision=1, deleted=None, error=None, celery_task_id=None):  # noqa: E501
