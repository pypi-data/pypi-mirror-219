...
class NodeExecutionEvent(_message.Message):
    __slots__ = ["error", "event_version", "id", "input_uri", "is_dynamic", "is_parent", "node_name", "occurred_at", "output_data", "output_uri", "parent_node_metadata", "parent_task_metadata", "phase", "producer_id", "retry_group", "spec_node_id", "task_node_metadata", "workflow_node_metadata"]
...
class TaskNodeMetadata(_message.Message):
    __slots__ = ["cache_status", "catalog_key", "dynamic_workflow", "reservation_status"]
    CACHE_STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, cache_status: _Optional[_Union[_catalog_pb2.CatalogCacheStatus, str]] = ..., catalog_key: _Optional[_Union[_catalog_pb2.CatalogMetadata, _Mapping]] = ..., reservation_status: _Optional[_Union[_catalog_pb2.CatalogReservation.Status, str]] = ..., dynamic_workflow: _Optional[_Union[DynamicWorkflowNodeMetadata, _Mapping]] = ...) -> None: ...
