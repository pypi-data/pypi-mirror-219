...
_RECORDFIELD = _descriptor.Descriptor(
  name='RecordField',
  full_name='flyteidl.core.RecordField',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='flyteidl.core.RecordField.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='flyteidl.core.RecordField.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RECORD = _descriptor.Descriptor(
  name='Record',
  full_name='flyteidl.core.Record',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='fields', full_name='flyteidl.core.Record.fields', index=0,
...
_LITERAL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hash', full_name='flyteidl.core.Literal.hash', index=4,
...
_BINDINGDATARECORDFIELD = _descriptor.Descriptor(
  name='BindingDataRecordField',
  full_name='flyteidl.core.BindingDataRecordField',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='flyteidl.core.BindingDataRecordField.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='binding', full_name='flyteidl.core.BindingDataRecordField.binding', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BINDINGDATARECORD = _descriptor.Descriptor(
  name='BindingDataRecord',
  full_name='flyteidl.core.BindingDataRecord',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='fields', full_name='flyteidl.core.BindingDataRecord.fields', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BINDINGDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='union', full_name='flyteidl.core.BindingData.union', index=5,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RECORDFIELD.fields_by_name['value'].message_type = _LITERAL
...
_LITERAL.fields_by_name['record'].message_type = _RECORD
...
_BINDINGDATARECORDFIELD.fields_by_name['binding'].message_type = _BINDINGDATA
_BINDINGDATARECORD.fields_by_name['fields'].message_type = _BINDINGDATARECORDFIELD
...
_BINDINGDATA.fields_by_name['record'].message_type = _BINDINGDATARECORD
...
DESCRIPTOR.message_types_by_name['BindingDataRecordField'] = _BINDINGDATARECORDFIELD
DESCRIPTOR.message_types_by_name['BindingDataRecord'] = _BINDINGDATARECORD
...
RecordField = _reflection.GeneratedProtocolMessageType('RecordField', (_message.Message,), dict(
  ...
  __module__ = 'flyteidl.core.literals_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.RecordField)
  ))
...
Record = _reflection.GeneratedProtocolMessageType('Record', (_message.Message,), dict(
  DESCRIPTOR = _RECORD,
  __module__ = 'flyteidl.core.literals_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.Record)
  ))
...
BindingDataRecordField = _reflection.GeneratedProtocolMessageType('BindingDataRecordField', (_message.Message,), dict(
  DESCRIPTOR = _BINDINGDATARECORDFIELD,
  __module__ = 'flyteidl.core.literals_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.BindingDataRecordField)
  ))
_sym_db.RegisterMessage(BindingDataRecordField)

BindingDataRecord = _reflection.GeneratedProtocolMessageType('BindingDataRecord', (_message.Message,), dict(
  DESCRIPTOR = _BINDINGDATARECORD,
  __module__ = 'flyteidl.core.literals_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.BindingDataRecord)
  ))
_sym_db.RegisterMessage(BindingDataRecord)
