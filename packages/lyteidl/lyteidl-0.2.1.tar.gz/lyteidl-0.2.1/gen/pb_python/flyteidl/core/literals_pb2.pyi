...
class BindingData(_message.Message):
    __slots__ = ["collection", "map", "promise", "record", "scalar", "union"]
...
class BindingDataRecord(_message.Message):
    __slots__ = ["fields"]
    FIELDS_FIELD_NUMBER: _ClassVar[int]
    fields: _containers.RepeatedCompositeFieldContainer[BindingDataRecordField]
    def __init__(self, fields: _Optional[_Iterable[_Union[BindingDataRecordField, _Mapping]]] = ...) -> None: ...

class BindingDataRecordField(_message.Message):
    __slots__ = ["binding", "key"]
    BINDING_FIELD_NUMBER: _ClassVar[int]
    KEY_FIELD_NUMBER: _ClassVar[int]
    binding: BindingData
    key: str
    def __init__(self, key: _Optional[str] = ..., binding: _Optional[_Union[BindingData, _Mapping]] = ...) -> None: ...
...
class Literal(_message.Message):
    __slots__ = ["collection", "hash", "map", "record", "scalar"]
    COLLECTION_FIELD_NUMBER: _ClassVar[int]
    ...
    record: Record
    scalar: Scalar
    def __init__(self, scalar: _Optional[_Union[Scalar, _Mapping]] = ..., collection: _Optional[_Union[LiteralCollection, _Mapping]] = ..., map: _Optional[_Union[LiteralMap, _Mapping]] = ..., record: _Optional[_Union[Record, _Mapping]] = ..., hash: _Optional[str] = ...) -> None: ...
