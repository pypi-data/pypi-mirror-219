...
class TaskMetadata(_message.Message):
    __slots__ = ["cache_serializable", "deprecated_error_message", "discoverable", "discovery_version", "interruptible", "retries", "runtime", "timeout"]
