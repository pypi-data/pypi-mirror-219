...
class ExecutionRelaunchRequest(_message.Message):
    ...
    id: _identifier_pb2.WorkflowExecutionIdentifier
    name: str
    def __init__(self, id: _Optional[_Union[_identifier_pb2.WorkflowExecutionIdentifier, _Mapping]] = ..., name: _Optional[str] = ...) -> None: ...

class ExecutionSpec(_message.Message):
    __slots__ = ["annotations", "auth_role", "cluster_assignment", "disable_all", "inputs", "interruptible", "labels", "launch_plan", "max_parallelism", "metadata", "notifications", "quality_of_service", "raw_output_data_config", "security_context"]
