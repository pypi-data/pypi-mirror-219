...
class NodeExecutionClosure(_message.Message):
    __slots__ = ["created_at", "duration", "error", "output_data", "output_uri", "phase", "started_at", "task_node_metadata", "updated_at", "workflow_node_metadata"]
...
class TaskNodeMetadata(_message.Message):
    __slots__ = ["cache_status", "catalog_key"]
    ...
    def __init__(self, cache_status: _Optional[_Union[_catalog_pb2.CatalogCacheStatus, str]] = ..., catalog_key: _Optional[_Union[_catalog_pb2.CatalogMetadata, _Mapping]] = ...) -> None: ...
