...
_RECORDFIELDTYPE = _descriptor.Descriptor(
  name='RecordFieldType',
  full_name='flyteidl.core.RecordFieldType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='flyteidl.core.RecordFieldType.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='flyteidl.core.RecordFieldType.type', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LITERALTYPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='record_type', full_name='flyteidl.core.LiteralType.record_type', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='flyteidl.core.LiteralType.metadata', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='annotation', full_name='flyteidl.core.LiteralType.annotation', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='structure', full_name='flyteidl.core.LiteralType.structure', index=11,
...
_RECORDFIELDTYPE.fields_by_name['type'].message_type = _LITERALTYPE
_RECORDTYPE.fields_by_name['fields'].message_type = _RECORDFIELDTYPE
...
_LITERALTYPE.fields_by_name['record_type'].message_type = _RECORDTYPE
...
_LITERALTYPE.oneofs_by_name['type'].fields.append(
  _LITERALTYPE.fields_by_name['record_type'])
_LITERALTYPE.fields_by_name['record_type'].containing_oneof = _LITERALTYPE.oneofs_by_name['type']
...
DESCRIPTOR.message_types_by_name['RecordFieldType'] = _RECORDFIELDTYPE
...
RecordFieldType = _reflection.GeneratedProtocolMessageType('RecordFieldType', (_message.Message,), dict(
  DESCRIPTOR = _RECORDFIELDTYPE,
  __module__ = 'flyteidl.core.types_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.RecordFieldType)
  ))
_sym_db.RegisterMessage(RecordFieldType)
