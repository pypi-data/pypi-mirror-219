...
class LiteralType(_message.Message):
    __slots__ = ["annotation", "blob", "collection_type", "enum_type", "map_value_type", "metadata", "record_type", "schema", "simple", "structure", "structured_dataset_type", "union_type"]
    ...
    def __init__(self, simple: _Optional[_Union[SimpleType, str]] = ..., schema: _Optional[_Union[SchemaType, _Mapping]] = ..., collection_type: _Optional[_Union[LiteralType, _Mapping]] = ..., map_value_type: _Optional[_Union[LiteralType, _Mapping]] = ..., blob: _Optional[_Union[BlobType, _Mapping]] = ..., enum_type: _Optional[_Union[EnumType, _Mapping]] = ..., structured_dataset_type: _Optional[_Union[StructuredDatasetType, _Mapping]] = ..., union_type: _Optional[_Union[UnionType, _Mapping]] = ..., record_type: _Optional[_Union[RecordType, _Mapping]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., annotation: _Optional[_Union[TypeAnnotation, _Mapping]] = ..., structure: _Optional[_Union[TypeStructure, _Mapping]] = ...) -> None: ...
...
class RecordFieldType(_message.Message):
    __slots__ = ["key", "type"]
    KEY_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
    key: str
    type: LiteralType
    def __init__(self, key: _Optional[str] = ..., type: _Optional[_Union[LiteralType, _Mapping]] = ...) -> None: ...

class RecordType(_message.Message):
    __slots__ = ["fields"]
    FIELDS_FIELD_NUMBER: _ClassVar[int]
    fields: _containers.RepeatedCompositeFieldContainer[RecordFieldType]
    def __init__(self, fields: _Optional[_Iterable[_Union[RecordFieldType, _Mapping]]] = ...) -> None: ...
