...
class AddTagRequest(_message.Message):
    __slots__ = ["tag", "upsert"]
    TAG_FIELD_NUMBER: _ClassVar[int]
    UPSERT_FIELD_NUMBER: _ClassVar[int]
    tag: Tag
    upsert: bool
    def __init__(self, tag: _Optional[_Union[Tag, _Mapping]] = ..., upsert: bool = ...) -> None: ...
...
class CreateArtifactRequest(_message.Message):
    __slots__ = ["artifact", "upsert"]
    ARTIFACT_FIELD_NUMBER: _ClassVar[int]
    UPSERT_FIELD_NUMBER: _ClassVar[int]
    artifact: Artifact
    upsert: bool
    def __init__(self, artifact: _Optional[_Union[Artifact, _Mapping]] = ..., upsert: bool = ...) -> None: ...
