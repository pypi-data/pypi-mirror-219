...
class LaunchPlanSpec(_message.Message):
    __slots__ = ["annotations", "auth", "auth_role", "default_inputs", "entity_metadata", "fixed_inputs", "interruptible", "labels", "max_parallelism", "quality_of_service", "raw_output_data_config", "role", "security_context", "workflow_id"]
