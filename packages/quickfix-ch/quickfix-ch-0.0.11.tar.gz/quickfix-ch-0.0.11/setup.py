...
setup(
    ...
    package_data={'': ['spec/FIX*.xml']},
    include_package_data=True,
    author='Javier (coinhako)',
    author_email='javier.phon@coinhako.com',
    maintainer='Javier (coinhako)',
    maintainer_email='javier.phon@coinhako.com',
    ...
    ext_modules=[
        Extension(
            ...
            extra_compile_args=[
                '-std=c++0x', '-Wno-deprecated', '-Wno-unused-variable', '-Wno-deprecated-declarations', '-Wno-uninitialized'
            ]
        )
    ],
)
