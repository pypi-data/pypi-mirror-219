...
AVAILABLE_DOMAINS = ["amazon", "webcam", "dslr"]


class Office31DataModule(DomainAdaptationDataModule):
    def __init__(
            self,
            data_dir: str,
            domain: str,
        ...
        self.remoteFolder = LightningDataDefaults.OFFICE31_GOOGLE_DRIVE_SHARED_URL
