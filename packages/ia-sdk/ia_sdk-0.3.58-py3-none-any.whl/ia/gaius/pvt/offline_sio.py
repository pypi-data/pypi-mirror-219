...
class offline_sio:
    ...
    def make_report(self, filepath="report.html"):
        ...
        classification_counts = final_record['metrics']['counter']
        ...
        for node in testing_records[0]['metrics']['predicted'].keys():
            for record in testing_records:
                ...
                del tmp_record['metrics']['counter']
                del tmp_record['metrics']['training_counter']
                del tmp_record['metrics']['testing_counter']
