...
from noelgram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "noelgram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~noelgram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~noelgram.handlers.MessageHandler` the *update* argument will be a :obj:`~noelgram.types.Message`; in a :obj:`~noelgram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~noelgram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~noelgram.filters.command` or :meth:`~noelgram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~noelgram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~noelgram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~noelgram.types.Message`.
    ...
    async def func(flt, client: noelgram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~noelgram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~noelgram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~noelgram.types.InlineQuery`: The filter will match ``query``.
