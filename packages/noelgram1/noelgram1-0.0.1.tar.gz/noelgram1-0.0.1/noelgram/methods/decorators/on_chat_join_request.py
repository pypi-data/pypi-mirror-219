...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~noelgram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, noelgram.Client):
                self.add_handler(noelgram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        noelgram.handlers.ChatJoinRequestHandler(func, self),
