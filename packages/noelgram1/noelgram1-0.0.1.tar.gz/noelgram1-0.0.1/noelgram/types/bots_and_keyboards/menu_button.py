...
class MenuButton(Object):
    ...
    - :obj:`~noelgram.types.MenuButtonCommands`
    - :obj:`~noelgram.types.MenuButtonWebApp`
    - :obj:`~noelgram.types.MenuButtonDefault`

    If a menu button other than :obj:`~noelgram.types.MenuButtonDefault` is set for a private chat, then it is applied
    ...
    async def write(self, client: "noelgram.Client") -> "raw.base.BotMenuButton":
