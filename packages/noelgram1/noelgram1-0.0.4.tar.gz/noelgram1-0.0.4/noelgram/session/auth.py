...
from noelgram.crypto import aes, rsa, prime
from noelgram.errors import SecurityCheckMismatch
from noelgram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "noelgram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
