...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~noelgram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, noelgram.Client):
                self.add_handler(noelgram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        noelgram.handlers.ChatMemberUpdatedHandler(func, self),
