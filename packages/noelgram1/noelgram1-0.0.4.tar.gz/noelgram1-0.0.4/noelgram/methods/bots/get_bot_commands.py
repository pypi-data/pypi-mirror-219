...
import noelgram
from noelgram import raw, types
...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~noelgram.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~noelgram.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~noelgram.types.BotCommand`: On success, the list of bot commands is returned.
