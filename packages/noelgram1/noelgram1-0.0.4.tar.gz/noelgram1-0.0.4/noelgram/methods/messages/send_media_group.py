...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~noelgram.types.InputMediaPhoto`, :obj:`~noelgram.types.InputMediaVideo`, :obj:`~noelgram.types.InputMediaAudio` and :obj:`~noelgram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~noelgram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from noelgram.types import InputMediaPhoto, InputMediaVideo
