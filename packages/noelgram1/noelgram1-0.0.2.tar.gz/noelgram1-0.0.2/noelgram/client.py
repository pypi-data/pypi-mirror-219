...
import noelgram
from noelgram import __version__, __license__
from noelgram import enums
from noelgram import raw
from noelgram import utils
from noelgram.crypto import aes
from noelgram.errors import CDNFileHashMismatch
from noelgram.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from noelgram.handlers.handler import Handler
from noelgram.methods import Methods
from noelgram.session import Auth, Session
from noelgram.storage import FileStorage, MemoryStorage
from noelgram.types import User, TermsOfService
from noelgram.utils import ainput
...
class Client(Methods):
    """Noelgram Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~noelgram.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where Noelgram will store the session files.
    ...
    APP_VERSION = f"Noelgram {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to Noelgram (version {__version__})")
        print(f"Noelgram is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~noelgram.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.noelgram.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except noelgram.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
