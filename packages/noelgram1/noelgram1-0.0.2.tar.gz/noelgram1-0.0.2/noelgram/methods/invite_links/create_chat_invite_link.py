...
class CreateChatInviteLink:
    async def create_chat_invite_link(
        ...
        The link can be revoked using the method :meth:`~noelgram.Client.revoke_chat_invite_link`.
        ...
        Returns:
            :obj:`~noelgram.types.ChatInviteLink`: On success, the new invite link is returned.
