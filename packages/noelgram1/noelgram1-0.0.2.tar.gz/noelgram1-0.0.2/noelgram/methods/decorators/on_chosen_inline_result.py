...
import noelgram
from noelgram.filters import Filter
...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        This does the same thing as :meth:`~noelgram.Client.add_handler` using the
        :obj:`~noelgram.handlers.ChosenInlineResultHandler`.

        Parameters:
            filters (:obj:`~noelgram.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, noelgram.Client):
                self.add_handler(noelgram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        noelgram.handlers.ChosenInlineResultHandler(func, self),
