...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~noelgram.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~noelgram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~noelgram.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "noelgram". Get the first 50 results
                async for message in app.search_global("noelgram", limit=50):
                    print(message.text)
