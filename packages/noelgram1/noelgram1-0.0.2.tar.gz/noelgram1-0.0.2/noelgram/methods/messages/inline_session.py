...
from noelgram.errors import AuthBytesInvalid
from noelgram.session import Session
from noelgram.session.auth import Auth


async def get_session(client: "noelgram.Client", dc_id: int):
