...
import noelgram
from noelgram import StopTransmission, enums
from noelgram import raw
from noelgram import types
from noelgram import utils
from noelgram.errors import FilePartMissing
from noelgram.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~noelgram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~noelgram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~noelgram.Client.stop_transmission`, None is returned.
