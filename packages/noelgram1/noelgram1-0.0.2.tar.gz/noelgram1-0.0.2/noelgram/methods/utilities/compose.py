...
async def compose(
    clients: List["noelgram.Client"],
    sequential: bool = False
):
    """Run multiple clients at once.

    This method can be used to run multiple clients at once and can be found directly in the ``noelgram`` package.

    If you want to run a single client, you can use Client's bound method :meth:`~noelgram.Client.run`.

    Parameters:
        clients (List of :obj:`~noelgram.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from noelgram import Client, compose
