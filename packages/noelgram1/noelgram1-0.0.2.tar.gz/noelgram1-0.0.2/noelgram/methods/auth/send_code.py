...
from noelgram.errors import PhoneMigrate, NetworkMigrate
from noelgram.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~noelgram.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
