...
class BotCommandScope(Object):
    ...
    - :obj:`~noelgram.types.BotCommandScopeDefault`
    - :obj:`~noelgram.types.BotCommandScopeAllPrivateChats`
    - :obj:`~noelgram.types.BotCommandScopeAllGroupChats`
    - :obj:`~noelgram.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~noelgram.types.BotCommandScopeChat`
    - :obj:`~noelgram.types.BotCommandScopeChatAdministrators`
    - :obj:`~noelgram.types.BotCommandScopeChatMember`
    ...
    **Commands in group and supergroup chats**
    ...
    async def write(self, client: "noelgram.Client") -> "raw.base.BotCommandScope":
