...
class Object:
    def __init__(self, client: "noelgram.Client" = None):
        self._client = client

    def bind(self, client: "noelgram.Client"):
        """Bind a Client instance to this and to all nested Noelgram objects.

        Parameters:
            client (:obj:`~noelgram.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing Noelgram objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/noelgramchat/167281
