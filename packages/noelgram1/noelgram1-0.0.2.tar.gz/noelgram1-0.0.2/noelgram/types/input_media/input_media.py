...
class InputMedia(Object):
    ...
    - :obj:`~noelgram.types.InputMediaAnimation`
    - :obj:`~noelgram.types.InputMediaDocument`
    - :obj:`~noelgram.types.InputMediaAudio`
    - :obj:`~noelgram.types.InputMediaPhoto`
    - :obj:`~noelgram.types.InputMediaVideo`
    """
