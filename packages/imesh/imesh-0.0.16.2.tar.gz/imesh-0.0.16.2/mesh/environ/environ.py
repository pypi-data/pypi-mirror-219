...
class Environ:
    ...
    __open_telemetry_endpoint = ['open.telemetry.endpoint', 'open_telemetry_endpoint', 'OPEN_TELEMETRY_ENDPOINT', 'OTEL_EXPORTER_OTLP_ENDPOINT',
                                 'OTEL_EXPORTER_OTLP_TRACES_ENDPOINT']  # compat otel config
    __open_telemetry_protocol = ['open.telemetry.protocol', 'open_telemetry_protocol', 'OPEN_TELEMETRY_PROTOCOL']  # compat otel config
