...
def to_gantt_json(
    pool: FjspPool, save_folder: str, machine_rate: dict, sorted_dict={"加弹": 1, "整经": 2, "经编": 3, "剖绒": 4, "前整": 5}, op_status_dict={}
):
    gantt_data = []
    i = 0
    ...
    for machine_id in sorted(
        ...
        for op_id in scheduled_op_id:
            ...
            machine_op_dict["op_status"] = op_status_dict.get(op_id, "未下发")
