...
class ReduceMemoryObject(MemoryObject):
    ...
    def __init__(self, reduce_object: object) -> None:
        ...
        callable_constructor, constructor_arguments = self.constructor_builder(self.obj)

        self.constructor = get_constructor_kind(callable_constructor)
    ...
    def constructor_builder(self, obj: object):
        ...
        if is_reconstructor and is_user_type:
            ...
            # constructor = TypeInfo("builtins", "object.__new__")
