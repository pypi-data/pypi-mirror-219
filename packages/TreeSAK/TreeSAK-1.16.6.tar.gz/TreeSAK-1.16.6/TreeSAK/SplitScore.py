...
def SplitScoreStep2(args):
    ...
    grouped_marker_dir          = '%s/get_taxa_count_stats_wd/grouped_marker'               % step_2_op_dir
    ...
    group_marker(TaxaCountStats_output_txt, oma_op_fasta, grouped_marker_dir, force_overwrite)
