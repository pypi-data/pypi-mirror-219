...
def run_count_sister_taxa(genome_metadata_ar53, sponge_MAG_GTDB_archaea, hog_id_txt, contree_dir, ufboot_dir, gnm_cluster_txt, target_label, num_threads, output_dir, force_overwrite):
...
def get_taxa_count_stats(step_1_op_dir, hog_id_txt, get_taxa_count_stats_wd, force_overwrite, TaxaCountStats_Rscript):
...
def SplitScoreStep2(args):
    ...
    run_count_sister_taxa(gtdb_metadata_ar53, gtdb_classification_txt, hog_id_txt, step_1_op_dir, step_1_op_dir, gnm_group_txt, target_label, num_of_threads, count_sister_taxa_op_dir, force_overwrite)
    get_taxa_count_stats(count_sister_taxa_op_dir, hog_id_txt, get_taxa_count_stats_op_dir, force_overwrite, TaxaCountStats_Rscript)
