...
class ListenerCanceled(Exception):
    pass
newgram.errors.ListenerCanceled = ListenerCanceled

@patch(newgram.client.Client)
class Client():
    @patchable
...
@patch(newgram.handlers.message_handler.MessageHandler)
...
@patch(newgram.types.user_and_chats.chat.Chat)
class Chat(newgram.types.Chat):
    @patchable
...
@patch(newgram.types.user_and_chats.user.User)
class User(newgram.types.User):
    @patchable
    def listen(self, *args, **kwargs):
        return self._client.listen(self.id, *args, **kwargs)
    @patchable
