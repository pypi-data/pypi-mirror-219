...
message_list = [" Welcome! Until the 'Generating Files...' message, type 'finish' at any point to accept defaults for all remaining settings and constraints, or type 'restart' at any point to begin from scatch. (hit ENTER to begin)",
