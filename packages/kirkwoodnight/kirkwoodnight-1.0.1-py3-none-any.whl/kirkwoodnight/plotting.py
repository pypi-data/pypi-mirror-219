...
def plot_it(files_path):
    ...
    for i,time in enumerate(time_series):
        ...
        recording[time]['id'] = np.array(id_list,dtype=int)
        ...
        for i in range(len(ra)):
            ...
            ax.plot(radians, alt_deg.value, 'o', color='white', markersize=10, alpha=0, label=str(id_)+ ": " +names[i])
            ax.text(radians, alt_deg.value, str(id_), color='yellow', ha='center', va='center',zorder=10, rotation=0,fontweight='bold')
