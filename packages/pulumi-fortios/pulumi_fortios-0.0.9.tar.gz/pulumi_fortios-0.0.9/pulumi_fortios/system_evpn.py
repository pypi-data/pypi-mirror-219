...
__all__ = ['SystemEvpnArgs', 'SystemEvpn']

@pulumi.input_type
class SystemEvpnArgs:
    def __init__(__self__, *,
                 arp_suppression: Optional[pulumi.Input[str]] = None,
                 dynamic_sort_subtable: Optional[pulumi.Input[str]] = None,
                 export_rts: Optional[pulumi.Input[Sequence[pulumi.Input['SystemEvpnExportRtArgs']]]] = None,
                 fosid: Optional[pulumi.Input[int]] = None,
                 get_all_tables: Optional[pulumi.Input[str]] = None,
                 import_rts: Optional[pulumi.Input[Sequence[pulumi.Input['SystemEvpnImportRtArgs']]]] = None,
    ...
    def export_rts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SystemEvpnExportRtArgs']]]]:
        return pulumi.get(self, "export_rts")

    @export_rts.setter
    def export_rts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SystemEvpnExportRtArgs']]]]):
    ...
    def import_rts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SystemEvpnImportRtArgs']]]]:
        return pulumi.get(self, "import_rts")

    @import_rts.setter
    def import_rts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SystemEvpnImportRtArgs']]]]):
...
class SystemEvpn(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 arp_suppression: Optional[pulumi.Input[str]] = None,
                 dynamic_sort_subtable: Optional[pulumi.Input[str]] = None,
                 export_rts: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemEvpnExportRtArgs']]]]] = None,
                 fosid: Optional[pulumi.Input[int]] = None,
                 get_all_tables: Optional[pulumi.Input[str]] = None,
                 import_rts: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemEvpnImportRtArgs']]]]] = None,
                 ip_local_learning: Optional[pulumi.Input[str]] = None,
                 rd: Optional[pulumi.Input[str]] = None,
                 vdomparam: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a SystemEvpn resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SystemEvpnArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SystemEvpn resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SystemEvpnArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SystemEvpnArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SystemEvpnArgs.__new__(SystemEvpnArgs)
        ...
        super(SystemEvpn, __self__).__init__(
            'fortios:index/systemEvpn:SystemEvpn',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            ip_local_learning: Optional[pulumi.Input[str]] = None,
            rd: Optional[pulumi.Input[str]] = None,
            vdomparam: Optional[pulumi.Input[str]] = None) -> 'SystemEvpn':
        """
        ...
        __props__ = _SystemEvpnState.__new__(_SystemEvpnState)
        ...
        __props__.__dict__["rd"] = rd
        __props__.__dict__["vdomparam"] = vdomparam
        return SystemEvpn(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="exportRts")
    def export_rts(self) -> pulumi.Output[Optional[Sequence['outputs.SystemEvpnExportRt']]]:
        return pulumi.get(self, "export_rts")
    ...
    @property
    @pulumi.getter(name="importRts")
    def import_rts(self) -> pulumi.Output[Optional[Sequence['outputs.SystemEvpnImportRt']]]:
        return pulumi.get(self, "import_rts")
