    ...
    def getlayouttextaidata(self):
        try:
            ...
            if ai_proc_templ:
                ...
                if ent_name.strip() and (isinstance(ent_code, str) and ent_code.strip()):       
            ...
            for page_no in range(len(OCR_Text)):
                if start in OCR_Text[page_no] :   # if start present in ocr 
                    ...
                    if end == "":
                        ...
                        subStringOcrList.append(OCR_Text[page_no][StartIndex : ])
                    else:
                        EndIndex = OCR_Text[page_no].find(end)
                        subStringOcrList.append(OCR_Text[page_no][StartIndex : EndIndex])
                else:
