...
Retrieve your message status using `tnzapi-python` library.
...
Amend your message using `tnzapi-python` library.
...
Manage your contact group relationship using `tnzapi-python` library.
