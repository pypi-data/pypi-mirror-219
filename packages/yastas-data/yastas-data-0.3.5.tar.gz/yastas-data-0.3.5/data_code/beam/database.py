...
class GetQuery(beam.DoFn):
    def __init__(self, host, port, database, query, project_id, secret_user, secret_password):
        self.host=host
        self.port=port
    ...
    def process(self, element):
        ...
        schema, query_result=self.postgres.execute_query(self.conn, query=self.query)        
