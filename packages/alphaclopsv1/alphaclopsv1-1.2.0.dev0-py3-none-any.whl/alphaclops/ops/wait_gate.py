...
class WaitGate(raw_types.Gate):
    ...
    def __init__(
        self,
        duration: 'alphaclops.DURATION_LIKE',
        ...
        Args:
            duration: A constant or parameterized wait duration. This can be
                an instance of `datetime.timedelta` or `alphaclops.Duration`.
    ...
    @property
    def duration(self) -> 'alphaclops.Duration':
    ...
    def _resolve_parameters_(self, resolver: 'alphaclops.ParamResolver', recursive: bool) -> 'WaitGate':
        return WaitGate(
    ...
    def __repr__(self) -> str:
        return f'alphaclops.WaitGate({repr(self.duration)})'
...
def wait(
    *target: 'alphaclops.Qid',
    duration: 'alphaclops.DURATION_LIKE' = None,
