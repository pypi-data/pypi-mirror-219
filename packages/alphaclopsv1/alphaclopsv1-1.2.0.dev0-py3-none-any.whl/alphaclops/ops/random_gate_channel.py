...
class RandomGateChannel(raw_types.Gate):
    ...
    def __init__(self, *, sub_gate: 'alphaclops.Gate', probability: 'alphaclops.TParamVal'):
        if (
    ...
    @property
    def probability(self) -> 'alphaclops.TParamVal':
    ...
    ) -> Optional['alphaclops.CircuitDiagramInfo']:
    ...
    def __repr__(self):
        if self.probability == 1:
            return f'alphaclops.RandomGateChannel(sub_gate={self.sub_gate!r}, probability=1)'
