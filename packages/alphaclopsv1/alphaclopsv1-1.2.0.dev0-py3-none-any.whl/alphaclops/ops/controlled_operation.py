...
from alphaclops import protocols, qis, value
...
class ControlledOperation(raw_types.Operation):
    ...
    def __init__(
        self,
        controls: Sequence['alphaclops.Qid'],
        ...
        if protocols.num_qubits(control_values) != len(controls):
            raise ValueError('alphaclops.num_qubits(control_values) != len(controls)')
    ...
    @property
    def controls(self) -> Tuple['alphaclops.Qid', ...]:
    ...
    @property
    def gate(self) -> Optional['alphaclops.ControlledGate']:
    ...
    def __repr__(self):
        ...
        return (
            f'alphaclops.ControlledOperation('
