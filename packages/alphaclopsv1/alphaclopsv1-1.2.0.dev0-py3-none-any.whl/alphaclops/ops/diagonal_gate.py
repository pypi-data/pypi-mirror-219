...
from alphaclops.ops import common_gates, raw_types, global_phase_op
...
class DiagonalGate(raw_types.Gate):
    ...
    def __init__(self, diag_angles_radians: Sequence['alphaclops.TParamVal']) -> None:
        ...
        """
        self._diag_angles_radians: Tuple['alphaclops.TParamVal', ...] = tuple(diag_angles_radians)

    @property
    def diag_angles_radians(self) -> Tuple['alphaclops.TParamVal', ...]:
    ...
    def _decompose_for_basis(
        self, index: int, bit_flip: int, theta: 'alphaclops.TParamVal', qubits: Sequence['alphaclops.Qid']
    ) -> Iterator[Union['alphaclops.ZPowGate', 'alphaclops.CXPowGate']]:
        if index == 0:
            return []
    ...
    def __repr__(self) -> str:
        return 'alphaclops.DiagonalGate([{}])'.format(
