...
def test_qasm_output_args_validate():
    args = alphaclops.QasmArgs(version='2.0')
...
def test_qasm_output_args_format():
    ...
    m_a = alphaclops.measure(a, key='meas_a')
    m_b = alphaclops.measure(b, key='meas_b')
    ...
    assert args.format('_{0:meas}_', alphaclops.measurement_key_name(m_a)) == '_m_a_'
    assert args.format('_{0:meas}_', alphaclops.measurement_key_name(m_b)) == '_m_b_'
