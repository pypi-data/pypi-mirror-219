...
class PauliStringPhasor(gate_operation.GateOperation):
    ...
    @property
    def gate(self) -> 'alphaclops.PauliStringPhasorGate':
    ...
    @property
    def pauli_string(self) -> 'alphaclops.PauliString':
    ...
    def __repr__(self) -> str:
        return (
            f'alphaclops.PauliStringPhasor({self.pauli_string!r}, '
...
class PauliStringPhasorGate(raw_types.Gate):
    ...
    @property
    def dense_pauli_string(self) -> 'alphaclops.DensePauliString':
    ...
    def equal_up_to_global_phase(self, other: 'alphaclops.PauliStringPhasorGate') -> bool:
        """Checks equality of two PauliStringPhasors, up to global phase."""
    ...
    def _to_z_basis_ops(self, qubits: Sequence['alphaclops.Qid']) -> Iterator[raw_types.Operation]:
    ...
    def __repr__(self) -> str:
        return (
            f'alphaclops.PauliStringPhasorGate({self.dense_pauli_string!r}, '
            f'exponent_neg={proper_repr(self.exponent_neg)}, '
            f'exponent_pos={proper_repr(self.exponent_pos)})'
        )
    ...
    def on(self, *qubits: 'alphaclops.Qid') -> 'alphaclops.PauliStringPhasor':
...
def xor_nonlocal_decompose(
    qubits: Iterable[raw_types.Qid], onto_qubit: 'alphaclops.Qid'
