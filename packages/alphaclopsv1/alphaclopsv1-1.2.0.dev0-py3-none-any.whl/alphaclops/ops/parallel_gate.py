...
class ParallelGate(raw_types.Gate):
    ...
    def __init__(self, sub_gate: 'alphaclops.Gate', num_copies: int) -> None:
        """Inits ParallelGate.
    ...
    def with_gate(self, sub_gate: 'alphaclops.Gate') -> 'ParallelGate':
    ...
    def __repr__(self) -> str:
        return f'alphaclops.ParallelGate(sub_gate={self.sub_gate!r}, num_copies={self._num_copies})'
...
def parallel_gate_op(gate: 'alphaclops.Gate', *targets: 'alphaclops.Qid') -> 'alphaclops.Operation':
