...
from alphaclops.ops import raw_types, swap_gates
...
class QubitPermutationGate(raw_types.Gate):
    ...
    def __init__(self, permutation: Sequence[int]):
        """Create a `alphaclops.QubitPermutationGate`.
    ...
    def _decompose_(self, qubits: Sequence['alphaclops.Qid']) -> 'alphaclops.OP_TREE':
        ...
        def _swap_if_out_of_order(idx: int) -> Iterable['alphaclops.Operation']:
            nonlocal is_sorted
    ...
    def __repr__(self) -> str:
        return f'alphaclops.QubitPermutationGate(permutation={self.permutation!r})'
