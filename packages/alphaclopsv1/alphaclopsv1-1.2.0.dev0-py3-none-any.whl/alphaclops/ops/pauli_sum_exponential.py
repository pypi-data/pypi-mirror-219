...
from alphaclops import linalg, protocols, value, _compat
from alphaclops.ops import linear_combinations, pauli_string_phasor

if TYPE_CHECKING:
    import alphaclops


def _all_pauli_strings_commute(pauli_sum: 'alphaclops.PauliSum') -> bool:
    for x in pauli_sum:
        for y in pauli_sum:
...
class PauliSumExponential:
    ...
    def __init__(
        self,
        pauli_sum_like: 'alphaclops.PauliSumLike',
    ...
    def with_qubits(self, *new_qubits: 'alphaclops.Qid') -> 'PauliSumExponential':
    ...
    def __iter__(self) -> Iterator['alphaclops.PauliStringPhasor']:
    ...
    def __repr__(self) -> str:
        ...
        return f'alphaclops.{class_name}({self._pauli_sum!r}, {self._exponent!r})'
