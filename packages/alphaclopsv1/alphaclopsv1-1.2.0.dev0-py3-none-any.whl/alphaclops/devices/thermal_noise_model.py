...
from alphaclops import devices, ops, protocols, qis
...
def _as_rate_dict(
    rate_or_dict: Optional[Union[float, Dict['alphaclops.Qid', float]]], qubits: Set['alphaclops.Qid']
) -> Dict['alphaclops.Qid', float]:
...
def _validate_rates(qubits: Set['alphaclops.Qid'], rates: Dict['alphaclops.Qid', np.ndarray]) -> None:
...
class ThermalNoiseModel(devices.NoiseModel):
    ...
    def __init__(
        self,
        qubits: Set['alphaclops.Qid'],
        gate_durations_ns: Dict[type, float],
        heat_rate_GHz: Union[float, Dict['alphaclops.Qid', float], None] = None,
        cool_rate_GHz: Union[float, Dict['alphaclops.Qid', float], None] = None,
        dephase_rate_GHz: Union[float, Dict['alphaclops.Qid', float], None] = None,
        ...
        self.rate_matrix_GHz: Dict['alphaclops.Qid', np.ndarray] = rate_dict
    ...
    def noisy_moment(
        ...
        noise_ops: List['alphaclops.Operation'] = []
