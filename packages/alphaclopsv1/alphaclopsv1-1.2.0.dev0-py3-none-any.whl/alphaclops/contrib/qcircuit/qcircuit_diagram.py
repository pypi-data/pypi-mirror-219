...
from alphaclops.contrib.qcircuit.qcircuit_diagram_info import (
...
def qcircuit_qubit_namer(qubit: 'alphaclops.Qid') -> str:
...
def circuit_to_latex_using_qcircuit(
    circuit: 'alphaclops.Circuit', qubit_order: 'alphaclops.QubitOrderOrList' = ops.QubitOrder.DEFAULT
) -> str:
