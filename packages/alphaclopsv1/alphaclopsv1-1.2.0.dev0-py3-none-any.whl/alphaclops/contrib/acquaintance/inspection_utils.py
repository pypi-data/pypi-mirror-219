...
from alphaclops.contrib.acquaintance.executor import AcquaintanceOperation, ExecutionStrategy
from alphaclops.contrib.acquaintance.mutation_utils import expose_acquaintance_gates
from alphaclops.contrib.acquaintance.permutation import LogicalIndex, LogicalMapping
...
def get_acquaintance_dag(strategy: 'alphaclops.Circuit', initial_mapping: LogicalMapping):
...
def get_logical_acquaintance_opportunities(
    strategy: 'alphaclops.Circuit', initial_mapping: LogicalMapping
