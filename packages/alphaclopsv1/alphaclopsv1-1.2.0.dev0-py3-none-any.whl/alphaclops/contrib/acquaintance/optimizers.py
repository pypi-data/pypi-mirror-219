...
from alphaclops.contrib.acquaintance.executor import AcquaintanceOperation
from alphaclops.contrib.acquaintance.mutation_utils import expose_acquaintance_gates
from alphaclops.contrib.acquaintance.inspection_utils import LogicalAnnotator

if TYPE_CHECKING:
    import alphaclops


def remove_redundant_acquaintance_opportunities(strategy: 'alphaclops.Circuit') -> int:
