...
from alphaclops import circuits, ops, transformers

from alphaclops.contrib.acquaintance.gates import SwapNetworkGate, AcquaintanceOpportunityGate
from alphaclops.contrib.acquaintance.devices import get_acquaintance_size
from alphaclops.contrib.acquaintance.permutation import PermutationGate
...
def rectify_acquaintance_strategy(circuit: 'alphaclops.Circuit', acquaint_first: bool = True) -> None:
