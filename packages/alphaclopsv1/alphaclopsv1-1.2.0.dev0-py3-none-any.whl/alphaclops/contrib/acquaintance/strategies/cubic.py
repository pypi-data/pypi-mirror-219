...
from alphaclops.contrib.acquaintance.permutation import LinearPermutationGate, SwapPermutationGate
...
def cubic_acquaintance_strategy(
    qubits: Iterable['alphaclops.Qid'], swap_gate: 'alphaclops.Gate' = ops.SWAP
) -> 'alphaclops.Circuit':
