...
from alphaclops.contrib.acquaintance.permutation import SwapPermutationGate, PermutationGate
...
class CircularShiftGate(PermutationGate):
    ...
    def __init__(self, num_qubits: int, shift: int, swap_gate: 'alphaclops.Gate' = ops.SWAP) -> None:
    ...
    def __repr__(self) -> str:
        return (
            'alphaclops.contrib.acquaintance.CircularShiftGate('
