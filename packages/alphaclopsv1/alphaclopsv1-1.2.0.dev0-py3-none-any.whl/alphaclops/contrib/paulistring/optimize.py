...
from alphaclops import ops, circuits, transformers
...
class _CZTargetGateSet(transformers.CZTargetGateset):
    """Private implementation of `alphaclops.CZTargetGateset` used for optimized_circuit method below.

    The implementation extends `alphaclops.CZTargetGateset` by modifying decomposed operations using
