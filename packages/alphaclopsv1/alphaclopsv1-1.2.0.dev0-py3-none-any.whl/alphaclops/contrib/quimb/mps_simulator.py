...
from alphaclops import devices, protocols, qis, value
from alphaclops.sim import simulator_base
...
class MPSSimulator(
    ...
    def __init__(
        ...
        grouping: Optional[Dict['alphaclops.Qid', int]] = None,
    ):
    ...
    def _create_step_result(self, sim_state: 'alphaclops.SimulationStateBase[MPSState]'):
    ...
    def _create_simulator_trial_result(
        ...
        final_simulator_state: 'alphaclops.SimulationStateBase[MPSState]',
    ) -> 'MPSTrialResult':
...
class MPSTrialResult(simulator_base.SimulationTrialResultBase['MPSState']):
    ...
    def _repr_pretty_(self, p: Any, cycle: bool):
        ...
        if cycle:
            ...
            p.text('alphaclops.MPSTrialResult(...)')
        else:
            p.text(str(self))
...
class MPSSimulatorStepResult(simulator_base.StepResultBase['MPSState']):
    ...
    def __init__(self, sim_state: 'alphaclops.SimulationStateBase[MPSState]'):
    ...
    def _repr_pretty_(self, p: Any, cycle: bool):
        """iPython (Jupyter) pretty print."""
        p.text("alphaclops.MPSSimulatorStepResult(...)" if cycle else self.__str__())
...
class _MPSHandler(qis.QuantumStateRepresentation):
    ...
    def create(
        ...
        *,
        ...
        # circuit_to_tensors in alphaclops.contrib.quimb.state_vector.
...
class MPSState(SimulationState[_MPSHandler]):
    ...
    def partial_trace(self, keep_qubits: Set['alphaclops.Qid']) -> np.ndarray:
