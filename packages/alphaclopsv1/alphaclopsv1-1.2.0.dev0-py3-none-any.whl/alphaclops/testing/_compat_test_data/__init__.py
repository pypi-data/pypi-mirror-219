...
See alphaclops/_compat_test.py for the tests.
...
# fake_ops -> alphaclops.ops
_compat.deprecated_submodule(
    new_module_name="alphaclops.ops",
    old_parent=__name__,
    old_child="fake_ops",
    deadline="v0.20",
    create_attribute=False,
...
# this will be the case with alphaclops.google -> alphaclops_google
...
# alphaclops.testing._compat_test_data.repeated_child ->
# alphaclops.testing._compat_test_data.repeated
# now...repeated has also a submodule named alphaclops.testing._compat_test_data.repeated_child.child
# which adds to
# alphaclops.testing._compat_test_data.repeated_child.alphaclops.testing._compat_test_data.repeated_child.child
_compat.deprecated_submodule(
