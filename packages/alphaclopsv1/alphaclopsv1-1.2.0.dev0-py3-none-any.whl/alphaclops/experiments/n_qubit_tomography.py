...
from alphaclops import circuits, ops, protocols, study
from alphaclops.experiments.qubit_characterizations import TomographyResult
...
class StateTomographyExperiment:
    ...
    def __init__(
        ...
        Args:
            ...
            prerotations: Tuples of (phase_exponent, exponent) parameters for
                ...
                rotation applied will be `alphaclops.PhasedXPowGate` with the
    ...
    def _make_state_tomography_matrix(self, qubits: Sequence['alphaclops.Qid']) -> np.ndarray:
...
def state_tomography(
    ...
    """This performs n qubit tomography on a alphaclops circuit
    ...
    Args:
        ...
        prerotations: Tuples of (phase_exponent, exponent) parameters for gates
            ...
            applied will be `alphaclops.PhasedXPowGate` with the specified values
...
def get_state_tomography_data(
    ...
    qubits: Sequence['alphaclops.Qid'],
    circuit: 'alphaclops.Circuit',
    rot_circuit: 'alphaclops.Circuit',
    rot_sweep: 'alphaclops.Sweep',
    repetitions: int = 1000,
) -> np.ndarray:
