...
from alphaclops import sim, value
...
class _Simulate2qXEBTask:
    ...
    param_resolver: 'alphaclops.ParamResolverOrSimilarType'


class _Simulate_2q_XEB_Circuit:
    """Closure used in `simulate_2q_xeb_circuits` so it works with multiprocessing."""

    def __init__(self, simulator: 'alphaclops.SimulatesIntermediateState'):
...
def simulate_2q_xeb_circuits(
    ...
    simulator: Optional['alphaclops.SimulatesIntermediateState'] = None,
):
    ...
    Args:
        ...
        simulator: A noiseless simulator used to simulate the circuits. By default, this is
            `alphaclops.Simulator`. The simulator must support the `alphaclops.SimulatesIntermediateState`
            interface.
    ...
    if simulator is None:
        ...
        # https://github.com/quantumlib/alphaclops/issues/3717
