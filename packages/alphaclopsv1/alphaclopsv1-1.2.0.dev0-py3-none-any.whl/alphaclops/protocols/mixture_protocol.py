...
from alphaclops.protocols.has_unitary_protocol import has_unitary
...
class SupportsMixture(Protocol):
    ...
    def _mixture_(self) -> Union[Sequence[Tuple[float, Any]], NotImplementedType]:
        ...
        This method is used by the global `alphaclops.mixture` method.
    ...
    def _has_mixture_(self) -> bool:
        ...
        This method is used by the global `alphaclops.has_mixture` method.  If this
