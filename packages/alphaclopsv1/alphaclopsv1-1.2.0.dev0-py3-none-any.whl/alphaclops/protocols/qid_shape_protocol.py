...
from alphaclops._doc import document, doc_private
...
class SupportsExplicitQidShape(Protocol):
    ...
    def _qid_shape_(self) -> Union[Tuple[int, ...], NotImplementedType]:
        ...
        This method is used by the global `alphaclops.qid_shape` method (and by
        `alphaclops.num_qubits` if `_num_qubits_` is not defined). If this
...
class SupportsExplicitNumQubits(Protocol):
    ...
    def _num_qubits_(self) -> Union[int, NotImplementedType]:
        ...
        This method is used by the global `alphaclops.num_qubits` method (and by
        `alphaclops.qid_shape` if `_qid_shape_` is not defined.  If this
