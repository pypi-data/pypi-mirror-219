...
def commutes(
    ...
    - Both values are `alphaclops.Operation` instances. If the operations apply to
    ...
    Args:
        v1: One of the values to check for commutativity. Can be a alphaclops object
            such as an operation, or a numpy matrix.
        v2: The other value to check for commutativity. Can be a alphaclops object
            such as an operation, or a numpy matrix.
    ...
    raise TypeError(
        ...
        f"argument or use `alphaclops.definitely_commutes`."
    )
