...
def measurement_key_objs(val: Any) -> FrozenSet['alphaclops.MeasurementKey']:
...
def is_measurement(val: Any) -> bool:
    ...
    or `alphaclops.measurement_keys` returns a non-empty result for them.
...
def with_rescoped_keys(
    val: Any,
    path: Tuple[str, ...],
    bindable_keys: Optional[FrozenSet['alphaclops.MeasurementKey']] = None,
):
