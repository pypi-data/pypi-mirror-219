...
import alphaclops
from alphaclops.json_resolver_cache import _class_resolver_dictionary
from alphaclops.testing.json import ModuleJsonTestSpec

TestSpec = ModuleJsonTestSpec(
    name="alphaclops",
    packages=[alphaclops, alphaclops.work],
