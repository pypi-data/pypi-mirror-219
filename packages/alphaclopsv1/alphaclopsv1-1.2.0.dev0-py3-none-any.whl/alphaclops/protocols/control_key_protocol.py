...
from alphaclops.protocols import measurement_key_protocol
...
class SupportsControlKey(Protocol):
    ...
    @doc_private
    def _control_keys_(self) -> Union[FrozenSet['alphaclops.MeasurementKey'], NotImplementedType, None]:
...
def control_keys(val: Any) -> FrozenSet['alphaclops.MeasurementKey']:
...
def measurement_keys_touched(val: Any) -> FrozenSet['alphaclops.MeasurementKey']:
