...
from alphaclops.protocols.apply_unitary_protocol import ApplyUnitaryArgs, apply_unitaries
...
class SupportsUnitary(Protocol):
    ...
    def _unitary_(self) -> Union[np.ndarray, NotImplementedType]:
        ...
        This method is used by the global `alphaclops.unitary` method. If this method
        ...
        or default result when calling `alphaclops.unitary` on it). (The ability to
        return NotImplemented is useful when a class cannot know if it has a
        matrix until runtime, e.g. alphaclops.X**c normally has a matrix but
        alphaclops.X**sympy.Symbol('a') doesn't.)
    ...
    def _has_unitary_(self) -> bool:
        ...
        This method is used by the global `alphaclops.has_unitary` method.  If this
