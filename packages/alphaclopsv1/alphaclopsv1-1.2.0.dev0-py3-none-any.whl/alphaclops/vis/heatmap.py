...
from alphaclops.vis import vis_utils

QubitTuple = Tuple[grid_qubit.TensorCircuit, ...]
...
class Heatmap:
    ...
    @overload
    def __init__(self, value_map: Mapping[grid_qubit.TensorCircuit, SupportsFloat], **kwargs):
        pass

    def __init__(
        self,
        value_map: Union[
            Mapping[QubitTuple, SupportsFloat], Mapping[grid_qubit.TensorCircuit, SupportsFloat]
        ],
        **kwargs,
    ):
...
class TwoQubitInteractionHeatmap(Heatmap):
    ...
    def __init__(self, value_map: Mapping[QubitTuple, SupportsFloat], **kwargs):
        ...
        properties of the plot. The valid argument list includes all arguments of alphaclops.vis.Heatmap()
        plus the following.
