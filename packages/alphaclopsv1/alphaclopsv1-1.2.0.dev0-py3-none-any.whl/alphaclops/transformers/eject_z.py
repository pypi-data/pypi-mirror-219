...
def _is_swaplike(gate: 'alphaclops.Gate'):
...
def eject_z(
    ...
    *,
    ...
    def dump_tracked_phase(qubits: Iterable[ops.Qid]) -> 'alphaclops.OP_TREE':
    ...
    def map_func(op: 'alphaclops.Operation', moment_index: int) -> 'alphaclops.OP_TREE':
