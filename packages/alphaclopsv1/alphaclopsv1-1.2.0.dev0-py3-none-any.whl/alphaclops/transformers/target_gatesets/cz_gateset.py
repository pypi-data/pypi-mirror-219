...
from alphaclops.transformers.analytical_decompositions import two_qubit_to_cz
...
class CZTargetGateset(compilation_target_gateset.TwoQubitCompilationTargetGateset):
    ...
    By default, `alphaclops.CZTargetGateset` will accept and compile unknown gates to
    the following universal target gateset:
    - `alphaclops.CZ` / `alphaclops.CZPowGate`: The two qubit entangling gate.
    ...
    this gateset, will be compiled to the default gateset (i.e. `alphaclops.CZ`/`alphaclops.CZPowGate`,
    `alphaclops.PhasedXZGate`, `alphaclops.MeasurementGate`).
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            allow_partial_czs: If set, all powers of the form `alphaclops.CZ**t`, and not just
             `alphaclops.CZ`, are part of this gateset.
    ...
    def _decompose_two_qubit_operation(self, op: 'alphaclops.Operation', _) -> 'alphaclops.OP_TREE':
