...
from alphaclops import ops, linalg, protocols
from alphaclops.transformers.analytical_decompositions import single_qubit_decompositions, two_qubit_to_cz
...
def _kak_decomposition_to_operations(
    q0: 'alphaclops.Qid', q1: 'alphaclops.Qid', kak: linalg.KakDecomposition, atol: float = 1e-8
) -> List[ops.Operation]:
