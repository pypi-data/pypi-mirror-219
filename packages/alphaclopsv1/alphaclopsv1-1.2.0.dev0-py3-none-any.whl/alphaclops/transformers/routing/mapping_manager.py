...
class MappingManager:
    ...
    def __init__(
        self, device_graph: nx.Graph, initial_mapping: Dict['alphaclops.Qid', 'alphaclops.Qid']
    ) -> None:
    ...
    def logical_to_physical(self) -> np.ndarray:
        ...
        Let `lq: alphaclops.Qid` be a logical qubit. Then the corresponding physical qubit that it
    ...
    def physical_to_logical(self) -> np.ndarray:
        ...
        Let `pq: alphaclops.Qid` be a physical qubit. Then the corresponding logical qubit that it
        maps to can be obtained by:
    ...
    def mapped_op(self, op: 'alphaclops.Operation') -> 'alphaclops.Operation':
