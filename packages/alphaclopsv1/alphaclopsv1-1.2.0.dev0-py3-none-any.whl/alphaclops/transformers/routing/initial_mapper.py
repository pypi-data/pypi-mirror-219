...
class RandomGridMapper(metaclass=abc.ABCMeta):
...
class HardCodedInitialMapper(RandomGridMapper):
    """Initial Mapper class takes a hard-coded mapping and returns it."""

    def __init__(self, _map: Dict['alphaclops.Qid', 'alphaclops.Qid']) -> None:
        self._map = _map
    ...
    def __repr__(self) -> str:
        return f'alphaclops.HardCodedInitialMapper({self._map})'
