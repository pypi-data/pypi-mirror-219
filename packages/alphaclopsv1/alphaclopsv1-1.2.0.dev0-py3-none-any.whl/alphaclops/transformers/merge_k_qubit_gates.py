...
from alphaclops import ops, protocols, circuits
...
def _rewrite_merged_k_qubit_unitaries(
    ...
    *,
    ...
    k: int = 0,
    rewriter: Optional[Callable[['alphaclops.CircuitOperation'], 'alphaclops.OP_TREE']] = None,
    merged_circuit_op_tag: str = "_merged_k_qubit_unitaries_component",
) -> 'alphaclops.Circuit':
    deep = context.deep if context else False

    def map_func(op: 'alphaclops.Operation', _) -> 'alphaclops.OP_TREE':
...
def merge_k_qubit_unitaries(
    ...
    *,
    ...
    `alphaclops.MatrixGate` containing unitary matrix of the merged component.
    ...
    Args:
        ...
        rewriter: Callable type that takes a `alphaclops.CircuitOperation`, encapsulating a connected
            component of unitary operations acting on <= k qubits, and produces a `alphaclops.OP_TREE`.
