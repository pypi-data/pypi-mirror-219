...
"""Transformer pass that expands composite operations via `alphaclops.decompose`."""
...
def expand_composite(
    ...
    *,
    ...
    """A transformer that expands composite operations via `alphaclops.decompose`.
    ...
    Transformation is applied using `alphaclops.map_operations_and_unroll`, which preserves the
