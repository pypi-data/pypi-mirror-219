...
ParamDictType = Dict['alphaclops.TParamKey', 'alphaclops.TParamValComplex']
ParamMappingType = Mapping['alphaclops.TParamKey', 'alphaclops.TParamValComplex']
document(ParamDictType, """Dictionary from symbols to values.""")
document(ParamMappingType, """Immutable map from symbols to values.""")

ParamResolverOrSimilarType = Union['alphaclops.ParamResolver', ParamMappingType, None]
document(
...
class ParamResolver:
    ...
    def __new__(cls, param_dict: 'alphaclops.ParamResolverOrSimilarType' = None):
        if isinstance(param_dict, ParamResolver):
            return param_dict
        return super().__new__(cls)

    def __init__(self, param_dict: 'alphaclops.ParamResolverOrSimilarType' = None) -> None:
    ...
    def value_of(
        self, value: Union['alphaclops.TParamKey', 'alphaclops.TParamValComplex'], recursive: bool = True
        ...
        alphaclops.flatten or other means so that formula resolution is avoided.
        ...
        if value in self.param_dict:
            ...
            param_value = self.param_dict[cast('alphaclops.TParamKey', value)]
    ...
    def _resolve_parameters_(self, resolver: 'ParamResolver', recursive: bool) -> 'ParamResolver':
        new_dict: Dict['alphaclops.TParamKey', Union[float, str, sympy.Symbol, sympy.Expr]] = {
    ...
    def __getitem__(
        self, key: Union['alphaclops.TParamKey', 'alphaclops.TParamValComplex']
    ) -> 'alphaclops.TParamValComplex':
    ...
    def __repr__(self) -> str:
        ...
        return f'alphaclops.ParamResolver({param_dict_repr})'
