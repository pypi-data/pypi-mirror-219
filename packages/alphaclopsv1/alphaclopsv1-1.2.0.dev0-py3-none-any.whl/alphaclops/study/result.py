...
from alphaclops import value, ops
...
T = TypeVar('T')
TMeasurementKey = Union[str, 'alphaclops.Qid', Iterable['alphaclops.Qid']]
...
class Result(abc.ABC):
    ...
    def data(self) -> pd.DataFrame:
        ...
        bits see `alphaclops.big_endian_int_to_bits` and similar functions.
        """
    ...
    def __add__(self, other: 'alphaclops.Result') -> 'alphaclops.Result':
        if not isinstance(other, Result):
            return NotImplemented
...
class ResultDict(Result):
    ...
    def __repr__(self) -> str:
        return f'alphaclops.ResultDict(params={self.params!r}, records={self._record_dict_repr()})'
