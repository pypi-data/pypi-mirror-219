...
def test_parse_random_state():
    ...
    prngs = [
        np.random,
        alphaclops.value.parse_random_state(np.random),
        alphaclops.value.parse_random_state(None),
    ]
    ...
    prngs = [
        ...
        alphaclops.value.parse_random_state(np.random.RandomState(seed)),
        alphaclops.value.parse_random_state(seed),
    ]
