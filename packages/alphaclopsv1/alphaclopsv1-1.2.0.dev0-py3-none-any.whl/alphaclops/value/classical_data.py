...
from alphaclops.value import digits, value_equality_attr
...
class MeasurementType(enum.IntEnum):
    ...
    `MEASUREMENT` represent measurements of a `alphaclops.Qid`
    ...
    def __repr__(self):
        return f'alphaclops.MeasurementType.{self.name}'


class ClassicalDataStoreReader(abc.ABC):
    @abc.abstractmethod
    def keys(self) -> Tuple['alphaclops.MeasurementKey', ...]:
        """Gets the measurement keys in the order they were stored."""

    @property
    @abc.abstractmethod
    def records(self) -> Mapping['alphaclops.MeasurementKey', List[Tuple[int, ...]]]:
        """Gets the a mapping from measurement key to measurement records."""

    @property
    @abc.abstractmethod
    def channel_records(self) -> Mapping['alphaclops.MeasurementKey', List[int]]:
        """Gets the a mapping from measurement key to channel measurement records."""

    @abc.abstractmethod
    def get_int(self, key: 'alphaclops.MeasurementKey', index=-1) -> int:
    ...
    @abc.abstractmethod
    def get_digits(self, key: 'alphaclops.MeasurementKey', index=-1) -> Tuple[int, ...]:
...
class ClassicalDataStore(ClassicalDataStoreReader, abc.ABC):
    ...
    def record_measurement(
        self, key: 'alphaclops.MeasurementKey', measurement: Sequence[int], qubits: Sequence['alphaclops.Qid']
    ):
    ...
    @abc.abstractmethod
    def record_channel_measurement(self, key: 'alphaclops.MeasurementKey', measurement: int):
...
class ClassicalDataDictionaryStore(ClassicalDataStore):
    ...
    def __init__(
        self,
        *,
        _records: Optional[Dict['alphaclops.MeasurementKey', List[Tuple[int, ...]]]] = None,
        _measured_qubits: Optional[
            Dict['alphaclops.MeasurementKey', List[Tuple['alphaclops.Qid', ...]]]
        ] = None,
        _channel_records: Optional[Dict['alphaclops.MeasurementKey', List[int]]] = None,
        _measurement_types: Optional[Dict['alphaclops.MeasurementKey', 'alphaclops.MeasurementType']] = None,
    ):
        ...
        if _channel_records is None:
            _channel_records = {}
        self._records: Dict['alphaclops.MeasurementKey', List[Tuple[int, ...]]] = _records
        self._measured_qubits: Dict[
            'alphaclops.MeasurementKey', List[Tuple['alphaclops.Qid', ...]]
        ] = _measured_qubits
        self._channel_records: Dict['alphaclops.MeasurementKey', List[int]] = _channel_records
        self._measurement_types: Dict[
            'alphaclops.MeasurementKey', 'alphaclops.MeasurementType'
        ] = _measurement_types
    ...
    @property
    def measured_qubits(self) -> Mapping['alphaclops.MeasurementKey', List[Tuple['alphaclops.Qid', ...]]]:
        """Gets the a mapping from measurement key to the qubits measured."""
        return self._measured_qubits

    @property
    def measurement_types(self) -> Mapping['alphaclops.MeasurementKey', 'alphaclops.MeasurementType']:
    ...
    def __repr__(self):
        rep = 'alphaclops.ClassicalDataDictionaryStore('
        if self.records:
