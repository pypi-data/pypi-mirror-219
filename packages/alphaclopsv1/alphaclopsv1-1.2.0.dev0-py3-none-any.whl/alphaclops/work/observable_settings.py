...
from alphaclops import ops, value, protocols
...
class InitObsSetting:
    ...
    def __repr__(self):
        return (
            f'alphaclops.work.InitObsSetting('
...
def zeros_state(qubits: Iterable['alphaclops.Qid']):
...
def observables_to_settings(
    observables: Iterable['alphaclops.PauliString'], qubits: Iterable['alphaclops.Qid']
...
class _MeasurementSpec:
    ...
    def __repr__(self):
        return (
            f'alphaclops.work._MeasurementSpec(max_setting={self.max_setting!r}, '
