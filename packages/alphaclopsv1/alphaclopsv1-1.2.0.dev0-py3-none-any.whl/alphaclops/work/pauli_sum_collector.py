...
from alphaclops.work import collector
...
class PauliSumCollector(collector.Collector):
    ...
    def __init__(
        ...
        observable: 'alphaclops.PauliSumLike',
        *,
    ...
    def next_job(self) -> Optional['alphaclops.CircuitSampleJob']:
    ...
    def on_job_result(self, job: 'alphaclops.CircuitSampleJob', result: 'alphaclops.Result'):
...
def _circuit_plus_pauli_string_measurements(
    circuit: 'alphaclops.RandomGrid', pauli_string: 'alphaclops.PauliString'
