...
from alphaclops import study, value
...
class CircuitSampleJob:
    ...
    def __init__(self, circuit: 'alphaclops.RandomGrid', *, repetitions: int, tag: Any = None):
    ...
    def __repr__(self) -> str:
        return (
            f'alphaclops.CircuitSampleJob(tag={self.tag!r}, '
    ...
    def collect(
        ...
        *,
        ...
        Examples:
            ...
            ```
            collector = alphaclops.PauliStringCollector(...)
    ...
    async def collect_async(
        ...
        *,
        ...
        Returns:
            ...
            collected.
        """
        results: duet.AsyncCollector[Tuple[CircuitSampleJob, 'alphaclops.Result']] = duet.AsyncCollector()
        job_error = None
        running_jobs = 0
