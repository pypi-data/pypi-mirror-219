...
from alphaclops.interop.quirk.cells.cell import CellMaker, ExplicitOperationsCell
...
def _measurement(identifier: str, basis_change: Optional['alphaclops.Gate'] = None) -> CellMaker:
    return CellMaker(
        ...
        maker=lambda args: ExplicitOperationsCell(
            ...
            basis_change=cast(
                Iterable['alphaclops.Operation'], [basis_change.on(*args.qubits)] if basis_change else ()
            ),
        ),
    )
