...
from alphaclops.interop.quirk.cells.parse import parse_formula
...
def _gate(identifier: str, gate: 'alphaclops.Gate') -> CellMaker:
    return CellMaker(
...
def _formula_gate(
    identifier: str, default_formula: str, gate_func: Callable[['alphaclops.TParamVal'], 'alphaclops.Gate']
) -> CellMaker:
    return CellMaker(
