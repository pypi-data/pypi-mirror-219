...
from alphaclops.interop.quirk.cells.cell import CellMaker, CELL_SIZES
...
def generate_all_unsupported_cell_makers() -> Iterator[CellMaker]:
    ...
    yield from _unsupported_gates(
        ...
        "|/⟩⟨/|",
        "0",
        reason='postselection is not implemented in alphaclops',
    )
    ...
    yield from _unsupported_gates(
        ...
        "YDetectControlReset",
        "ZDetectControlReset",
        reason="classical feedback is not implemented in alphaclops.",
    )
