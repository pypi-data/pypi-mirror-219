...
@overload
def pow(val: 'alphaclops.Gate', exponent: Any) -> 'alphaclops.Gate':
    pass


@overload
def pow(val: 'alphaclops.Operation', exponent: Any) -> 'alphaclops.Operation':
    pass


@overload
def pow(val: 'alphaclops.Gate', exponent: Any, default: TDefault) -> Union[TDefault, 'alphaclops.Gate']:
    pass


@overload
def pow(
    val: 'alphaclops.Operation', exponent: Any, default: TDefault
) -> Union[TDefault, 'alphaclops.Operation']:
    pass


@overload
def pow(val: 'alphaclops.Circuit', exponent: int, default: TDefault) -> Union[TDefault, 'alphaclops.Circuit']:
    pass
