...
from alphaclops import qis
from alphaclops._doc import doc_private
from alphaclops.protocols import qid_shape_protocol
from alphaclops.protocols.apply_unitary_protocol import ApplyUnitaryArgs
...
class SupportsExplicitHasUnitary(Protocol):
    ...
    def _has_unitary_(self) -> bool:
        ...
        This method is used preferentially by the global `alphaclops.has_unitary`
