...
from alphaclops.protocols.kraus_protocol import kraus
...
class SupportsApplyChannel(Protocol):
    ...
    def _apply_channel_(
        ...
        Args:
            args: A `alphaclops.ApplyChannelArgs` object with the `args.target_tensor`
...
def apply_channel(
    ...
    returns a non-default channel with `alphaclops.channel`, that channel will be
    ...
    Args:
        ...
        args: A mutable `alphaclops.ApplyChannelArgs` object describing the target
