...
def resolve_parameters(
    val: T, param_resolver: 'alphaclops.ParamResolverOrSimilarType', recursive: bool = True
) -> T:
    ...
    Returns:
        ...
        given `alphaclops.ParamResolver`. If `val` has no `_resolve_parameters_`
        ...
        for the much more common case of resolving parameters on alphaclops
...
def resolve_parameters_once(val: Any, param_resolver: 'alphaclops.ParamResolverOrSimilarType'):
