...
class QasmArgs(string.Formatter):
    ...
    def __init__(
        ...
        precision: int = 10,
        version: str = '2.0',
        qubit_id_map: Optional[Dict['alphaclops.Qid', str]] = None,
...
class SupportsQasmWithArgsAndQubits(Protocol):
    ...
    @doc_private
    def _qasm_(
        self, qubits: Tuple['alphaclops.Qid'], args: QasmArgs
...
def qasm(
    ...
    *,
    ...
    qubits: Optional[Iterable['alphaclops.Qid']] = None,
    ...
    Args:
        ...
        args: A `QasmArgs` object to pass into the value's `_qasm_` method.
            ...
            going on, e.g. a `alphaclops.Operation` in a bigger `alphaclops.Circuit`
        ...
        qubits: A list of qubits that the value is being applied to. This is
            needed for `alphaclops.Gate` values, which otherwise wouldn't know what
