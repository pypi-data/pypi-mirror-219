...
LabelEntity = Union['alphaclops.Qid', 'alphaclops.MeasurementKey']
...
class CircuitDiagramInfo:
    ...
    def _wire_symbols_including_formatted_exponent(
        self, args: 'alphaclops.CircuitDiagramInfoArgs', *, preferred_exponent_index: Optional[int] = None
    ) -> List[str]:
    ...
    def _formatted_exponent(self, args: 'alphaclops.CircuitDiagramInfoArgs') -> Optional[str]:
...
class CircuitDiagramInfoArgs:
    ...
    def __init__(
        self,
        known_qubits: Optional[Iterable['alphaclops.Qid']],
        known_qubit_count: Optional[int],
        use_unicode_characters: bool,
        precision: Optional[int],
        label_map: Optional[Dict['alphaclops.LabelEntity', int]],
    ...
    def format_complex(self, val: Union[sympy.Basic, int, float, 'alphaclops.TParamValComplex']) -> str:
        if isinstance(val, sympy.Basic):
            return str(val)
        c = complex(val)
        joiner = '+'
...
class SupportsCircuitDiagramInfo(Protocol):
    ...
    def _circuit_diagram_info_(
        ...
        This method is used by the global `alphaclops.diagram_info` method. If this
...
def _op_info_with_fallback(
    op: 'alphaclops.Operation', args: 'alphaclops.CircuitDiagramInfoArgs'
) -> 'alphaclops.CircuitDiagramInfo':
