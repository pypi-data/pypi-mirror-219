...
@overload
def inverse(val: 'alphaclops.Gate') -> 'alphaclops.Gate':
    pass


@overload
def inverse(val: 'alphaclops.Operation') -> 'alphaclops.Operation':
    pass


@overload
def inverse(val: 'alphaclops.Circuit') -> 'alphaclops.Circuit':
    pass


@overload
def inverse(val: 'alphaclops.OP_TREE') -> 'alphaclops.OP_TREE':
    pass


@overload
def inverse(val: 'alphaclops.Gate', default: TDefault) -> Union[TDefault, 'alphaclops.Gate']:
    pass


@overload
def inverse(val: 'alphaclops.Operation', default: TDefault) -> Union[TDefault, 'alphaclops.Operation']:
    pass


@overload
def inverse(val: 'alphaclops.Circuit', default: TDefault) -> Union[TDefault, 'alphaclops.Circuit']:
    pass


@overload
def inverse(val: 'alphaclops.OP_TREE', default: TDefault) -> Union[TDefault, 'alphaclops.OP_TREE']:
    pass
