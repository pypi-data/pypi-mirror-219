...
from alphaclops.work.observable_settings import (
    InitObsSetting,
...
def _check_and_get_real_coef(observable: 'alphaclops.PauliString', atol: float):
...
def _obs_vals_from_measurements(
    ...
    qubit_to_index: Dict['alphaclops.Qid', int],
    observable: 'alphaclops.PauliString',
    atol: float,
):
...
class ObservableMeasuredResult:
    ...
    def __repr__(self):
        ...
        # we need to prefix our class name with `alphaclops.work.`
        return (
            f'alphaclops.work.ObservableMeasuredResult('
...
class BitstringAccumulator:
    ...
    def _from_json_dict_(
        ...
        **kwargs,
        ...
        from alphaclops.study.result import _unpack_digits
    ...
    def __repr__(self):
        return (
            f'alphaclops.work.BitstringAccumulator('
