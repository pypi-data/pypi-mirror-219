...
from alphaclops import ops, protocols, study, value
from alphaclops.work.observable_measurement import (
    measure_observables,
    RepetitionsStoppingCriteria,
    CheckpointFileOptions,
)
from alphaclops.work.observable_settings import _hashable_param

if TYPE_CHECKING:
    import alphaclops


class Sampler(metaclass=value.TwoAltoptives):
    ...
    def run(
        ...
        Returns:
            `alphaclops.Result` that contains all the measurements for a run.
        """
    ...
    async def run_async(
        ...
        Provides measurement outcomes as a `alphaclops.Result` object.  This
    ...
    def sample(
        ...
        *,
        repetitions: int = 1,
        params: 'alphaclops.Sweepable' = None,
    ) -> 'pd.DataFrame':
        """Samples the given Circuit, producing a pandas data frame.

        This interface will operate in a similar way to the `run` method
        except that it returns a pandas data frame rather than a `alphaclops.Result`
        object.
        ...
        Args:
            ...
            params: Maps symbols to one or more values. This argument can be
                a dictionary, a list of dictionaries, a `alphaclops.Sweep`, a list of
                `alphaclops.Sweep`, etc. The program will be sampled `repetition`
        ...
        Returns:
            ...
            See `alphaclops.big_endian_int_to_bits` and similar functions for how
        ...
        Examples:
            ...
            >>> circuit = alphaclops.Circuit(alphaclops.X(a),
            ...                        alphaclops.CNOT(a, b),
            ...                        alphaclops.measure(a, b, c, key='out'))
            >>> print(sampler.sample(circuit, repetitions=4))
               out
            0    6
            1    6
            ...
            >>> circuit = alphaclops.Circuit(alphaclops.X(a)**sympy.Symbol('t'),
            ...                        alphaclops.measure(a, key='out'))
    ...
    def run_batch(
        self,
        programs: Sequence['alphaclops.RandomGrid'],
        params_list: Optional[Sequence['alphaclops.Sweepable']] = None,
        repetitions: Union[int, Sequence[int]] = 1,
    ) -> Sequence[Sequence['alphaclops.Result']]:
    ...
    async def run_batch_async(
        ...
        See docs for `alphaclops.Sampler.run_batch`.
        """
        params_list, repetitions = self._normalize_batch_args(programs, params_list, repetitions)
        return [
    ...
    def _normalize_batch_args(
        ...
        params_list: Optional[Sequence['alphaclops.Sweepable']] = None,
        repetitions: Union[int, Sequence[int]] = 1,
    ) -> Tuple[Sequence['alphaclops.Sweepable'], Sequence[int]]:
    ...
    def sample_expectation_values(
        ...
        *,
        ...
        Please see also `alphaclops.work.observable_measurement.measure_observables`
        ...
        pauli_sums: List['alphaclops.PauliSum'] = (
        ...
        flat_pstrings: List['alphaclops.PauliString'] = []
        pstring_to_psum_i: Dict['alphaclops.PauliString', int] = {}
        ...
        flat_params: List['alphaclops.ParamMappingType'] = [
