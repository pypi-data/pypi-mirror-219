...
from alphaclops.ops import eigen_gate, swap_gates
...
class PhasedISwapPowGate(eigen_gate.EigenGate):
    ...
    def _decompose_(self, qubits: Sequence['alphaclops.Qid']) -> 'alphaclops.OP_TREE':
        ...
        yield alphaclops.Z(a) ** self.phase_exponent
        yield alphaclops.Z(b) ** -self.phase_exponent
        yield alphaclops.ISwapPowGate(exponent=self.exponent, global_shift=self.global_shift).on(a, b)
        yield alphaclops.Z(a) ** -self.phase_exponent
        yield alphaclops.Z(b) ** self.phase_exponent
    ...
    def __repr__(self) -> str:
        ...
        return f'alphaclops.PhasedISwapPowGate({arg_string})'
