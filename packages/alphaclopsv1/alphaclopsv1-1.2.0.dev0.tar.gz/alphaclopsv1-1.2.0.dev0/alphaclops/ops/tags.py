...
class VirtualTag:
    """A `alphaclops.TaggedOperation` tag indicating that the operation is virtual.
    ...
    a noisy gate in a `alphaclops.NoiseModel`.
...
class RoutingSwapTag:
    """A 'alphaclops.TaggedOperation' tag indicated that the operation is an inserted SWAP.
    ...
    def __repr__(self) -> str:
        return 'alphaclops.RoutingSwapTag()'
