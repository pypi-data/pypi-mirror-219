...
from alphaclops.ops import gate_features, common_gates, eigen_gate, pauli_gates
...
class PauliInteractionGate(gate_features.InterchangeableQubitsGate, eigen_gate.EigenGate):
    ...
    @property
    def pauli0(self) -> 'alphaclops.Pauli':
        return self._pauli0
    ...
    @property
    def pauli1(self) -> 'alphaclops.Pauli':
        return self._pauli1
    ...
    def _circuit_diagram_info_(
        ...
        labels: Dict['alphaclops.Pauli', str] = {
            pauli_gates.X: 'X',
            pauli_gates.Y: 'Y',
            pauli_gates.Z: '@',
        }
    ...
    def __repr__(self) -> str:
        base = (
            f'alphaclops.PauliInteractionGate({self.pauli0!r}, {self.invert0!s}, '
