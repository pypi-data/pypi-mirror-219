...
class ProjectorString:
    """Mapping of `alphaclops.Qid` to measurement values (with a coefficient) representing a projector."""
    ...
    def __init__(
        ...
        Args:
            projector_dict: A python dictionary mapping from alphaclops.Qid to integers. A key value pair
    ...
    def __repr__(self) -> str:
        return (
            f"alphaclops.ProjectorString(projector_dict={self._projector_dict},"
