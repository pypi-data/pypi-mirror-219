...
class MixedUnitaryChannel(raw_types.Gate):
    ...
    def __init__(
        ...
        key: Union[str, 'alphaclops.MeasurementKey', None] = None,
        validate: bool = False,
    ):
    ...
    @staticmethod
    def from_mixture(
        mixture: 'protocols.SupportsMixture', key: Union[str, 'alphaclops.MeasurementKey', None] = None
    ):
    ...
    def __repr__(self):
        ...
        return f'alphaclops.MixedUnitaryChannel({", ".join(args)})'
