...
from alphaclops.ops import raw_types, common_gates
...
class TwoQubitDiagonalGate(raw_types.Gate):
    ...
    For example, `alphaclops.TwoQubitDiagonalGate([0, 1, -1, 0])` has the
    unitary matrix
    ...
    def __repr__(self) -> str:
        return 'alphaclops.TwoQubitDiagonalGate([{}])'.format(
