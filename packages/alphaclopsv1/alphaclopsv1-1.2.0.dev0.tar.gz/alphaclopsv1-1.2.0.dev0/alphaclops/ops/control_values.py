...
from alphaclops import protocols, value, _compat
...
class AbstractControlValues(abc.ABC):
    ...
    `alphaclops.ControlledGate` and `alphaclops.ControlledOperation` are useful to augment
    ...
    is represented by one of the implementations of `alphaclops.AbstractControlValues`.

    Implementations of `alphaclops.AbstractControlValues` can use different internal
    ...
    def expand(self) -> 'SumOfProducts':
        """Returns an expanded `alphaclops.SumOfProduct` representation of this control values."""
    ...
    def is_trivial(self) -> bool:
        ...
        This configuration is equivalent to `alphaclops.SumOfProducts(((1,) * num_controls))`
        and `alphaclops.ProductOfSums(((1,),) * num_controls)`
        """
    ...
    def __iter__(self) -> Iterator[Tuple[int, ...]]:
        ...
        >>> print(*alphaclops.ProductOfSums([(0, 1), (0,)]))
        (0, 1) (0,)
        >>> print(*alphaclops.SumOfProducts([(0, 0), (1, 0)]))
        (0, 0) (1, 0)
        """
    ...
    def __and__(self, other: 'AbstractControlValues') -> 'AbstractControlValues':
        ...
        >>> cv1 = alphaclops.ProductOfSums([(0, 1), 2])
        >>> cv2 = alphaclops.SumOfProducts([[0, 0], [1, 1]])
    ...
    def __or__(self, other: 'AbstractControlValues') -> 'AbstractControlValues':
        ...
        Raises:
            ValueError: If `alphaclops.num_qubits(self) != alphaclops.num_qubits(other)`.
        """
...
class ProductOfSums(AbstractControlValues):
    ...
    def __repr__(self) -> str:
        return f'alphaclops.ProductOfSums({str(self._qubit_sums)})'
...
class SumOfProducts(AbstractControlValues):
    ...
    1) `(|00><00| + |11><11|) X + (|01><01| + |10><10|) I` represents an
        ...
        >>> xor_cop = alphaclops.X(q2).controlled_by(q0, q1, control_values=xor_control_values)
    ...
    2) `(|00><00| + |01><01| + |10><10|) X + (|11><11|) I` represents an
        ...
        >>> nand_control_values = alphaclops.SumOfProducts(((0, 0), (0, 1), (1, 0)))
        >>> q0, q1, q2 = alphaclops.LineQubit.range(3)
        >>> nand_cop = alphaclops.X(q2).controlled_by(q0, q1, control_values=nand_control_values)
    """
    ...
    def __repr__(self) -> str:
        ...
        return f'alphaclops.SumOfProducts({self._conjunctions!s} {name})'
