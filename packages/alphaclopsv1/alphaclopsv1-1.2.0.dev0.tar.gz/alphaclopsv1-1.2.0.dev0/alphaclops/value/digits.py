...
def big_endian_bits_to_int(bits: Iterable[Any]) -> int:
    ...
    Examples:
        ...
        >>> alphaclops.big_endian_bits_to_int([0, 1])
        1

        >>> alphaclops.big_endian_bits_to_int([1, 0])
        2

        >>> alphaclops.big_endian_bits_to_int([0, 1, 0])
        2

        >>> alphaclops.big_endian_bits_to_int([1, 0, 0, 1, 0])
        18
    """
    result = 0
    for e in bits:
...
def big_endian_int_to_bits(val: int, *, bit_count: int) -> List[int]:
    ...
    Examples:
        >>> alphaclops.big_endian_int_to_bits(19, bit_count=8)
        [0, 0, 0, 1, 0, 0, 1, 1]

        >>> alphaclops.big_endian_int_to_bits(19, bit_count=4)
        [0, 0, 1, 1]

        >>> alphaclops.big_endian_int_to_bits(-3, bit_count=4)
        [1, 1, 0, 1]
    """
...
def big_endian_digits_to_int(digits: Iterable[int], *, base: Union[int, Iterable[int]]) -> int:
    ...
    Examples:
        ...
        >>> alphaclops.big_endian_digits_to_int([0, 1], base=10)
        1

        >>> alphaclops.big_endian_digits_to_int([1, 0], base=10)
        10

        >>> alphaclops.big_endian_digits_to_int([1, 2, 3], base=[2, 3, 4])
        23
    """
    digits = tuple(digits)
...
def big_endian_int_to_digits(
    ...
    Examples:
        >>> alphaclops.big_endian_int_to_digits(11, digit_count=4, base=10)
        [0, 0, 1, 1]

        >>> alphaclops.big_endian_int_to_digits(11, base=[2, 3, 4])
        [0, 2, 3]
    """
