...
class PeriodicValue:
    ...
    def _approx_eq_(self, other: Any, atol: float) -> bool:
        ...
        from alphaclops.protocols import approx_eq
    ...
    def __repr__(self) -> str:
        ...
        return f'alphaclops.PeriodicValue({v}, {p})'

    def _is_parameterized_(self) -> bool:
        # HACK: Avoids circular dependencies.
        from alphaclops.protocols import is_parameterized

        return is_parameterized(self.value) or is_parameterized(self.period)

    def _parameter_names_(self) -> AbstractSet[str]:
        # HACK: Avoids circular dependencies.
        from alphaclops.protocols import parameter_names
    ...
    def _resolve_parameters_(
        ...
        # HACK: Avoids circular dependencies.
        from alphaclops.protocols import resolve_parameters
