...
from alphaclops import devices, ops, value

from alphaclops.contrib.graph_device.hypergraph import UndirectedHypergraph
...
class UndirectedGraphDevice(devices.Device):
    ...
    def qubits(self) -> Tuple['alphaclops.Qid', ...]:
        return cast(Tuple['alphaclops.Qid', ...], tuple(sorted(self.device_graph.vertices)))
    ...
    def validate_moment(self, moment: 'alphaclops.Moment'):
