...
from alphaclops import devices, ops, protocols
from alphaclops.contrib.acquaintance.permutation import PermutationGate, update_mapping
...
def assert_permutation_decomposition_equivalence(gate: PermutationGate, n_qubits: int) -> None:
    ...
    operations = list(cast(Sequence['alphaclops.Operation'], ops.flatten_op_tree(operations)))
