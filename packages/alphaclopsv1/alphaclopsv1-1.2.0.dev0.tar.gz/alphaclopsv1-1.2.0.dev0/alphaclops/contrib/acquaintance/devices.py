...
from alphaclops import circuits, devices, ops
from alphaclops.contrib.acquaintance.gates import AcquaintanceOpportunityGate, SwapNetworkGate
from alphaclops.contrib.acquaintance.bipartite import BipartiteSwapNetworkGate
