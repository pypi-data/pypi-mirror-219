...
from alphaclops.contrib.acquaintance.gates import acquaint
from alphaclops.contrib.acquaintance.permutation import PermutationGate, SwapPermutationGate
...
class BipartiteGraphType(enum.Enum):
    ...
    def __repr__(self) -> str:
        return 'alphaclops.contrib.acquaintance.bipartite.BipartiteGraphType.' + self.name
...
class BipartiteSwapNetworkGate(PermutationGate):
    ...
    def decompose_complete(self, qubits: Sequence['alphaclops.Qid']) -> 'alphaclops.OP_TREE':
    ...
    def decompose_matching(self, qubits: Sequence['alphaclops.Qid']) -> 'alphaclops.OP_TREE':
        swap_gate = SwapPermutationGate(self.swap_gate)
    ...
    def __repr__(self) -> str:
        ...
        args_str = ', '.join(args)
        return f'alphaclops.contrib.acquaintance.bipartite.BipartiteSwapNetworkGate({args_str})'
