...
from alphaclops.ops import common_gates, pauli_gates, raw_types
...
class BayesianNetworkGate(raw_types.Gate):
    ...
    def _decompose_(self, qubits: Sequence['raw_types.Qid']) -> 'alphaclops.OP_TREE':
    ...
    def __repr__(self) -> str:
        return (
            f'alphaclops.BayesianNetworkGate('
