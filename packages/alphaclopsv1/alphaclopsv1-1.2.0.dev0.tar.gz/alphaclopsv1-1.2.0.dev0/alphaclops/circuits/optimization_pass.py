...
if TYPE_CHECKING:
    import alphaclops
    from alphaclops.ops import Qid
...
class PointOptimizationSummary:
    ...
    def __init__(
        self,
        clear_span: int,
        clear_qubits: Iterable['alphaclops.Qid'],
        new_operations: 'alphaclops.OP_TREE',
        ...
        Args:
            ...
            new_operations: The operations to replace the cleared out
                operations with.
            preserve_moments: If set, `alphaclops.Moment` instances within
                ...
                see https://github.com/quantumlib/alphaclops/issues/2406.
        """
    ...
    def __repr__(self) -> str:
        return (
            f'alphaclops.PointOptimizationSummary({self.clear_span!r}, '
...
class PointOptimizer:
    ...
    def __init__(
        ...
        post_clean_up: Callable[
            [Sequence['alphaclops.Operation']], 'alphaclops.OP_TREE'
    ...
    def __call__(self, circuit: 'alphaclops.Circuit'):
    ...
    def optimization_at(
        ...
        PointOptimizationSummary(clear_span=2,
                                 ...
                                 new_operations=alphaclops.Y(op.qubits[0]))
    ...
    def optimize_circuit(self, circuit: 'alphaclops.Circuit'):
