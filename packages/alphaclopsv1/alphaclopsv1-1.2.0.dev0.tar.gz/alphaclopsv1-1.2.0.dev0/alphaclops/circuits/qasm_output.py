...
from alphaclops import ops, linalg, protocols, value
...
class QasmUGate(ops.Gate):
    ...
    def _qasm_(self, qubits: Tuple['alphaclops.Qid', ...], args: 'alphaclops.QasmArgs') -> str:
    ...
    def __repr__(self) -> str:
        return (
            f'alphaclops.circuits.qasm_output.QasmUGate('
...
class QasmTwoQubitGate(ops.Gate):
    def __init__(self, kak: 'alphaclops.KakDecomposition') -> None:
    ...
    def __repr__(self) -> str:
        return f'alphaclops.circuits.qasm_output.QasmTwoQubitGate({self.kak!r})'
...
class QasmOutput:
    ...
    in alphaclops, are not yet supported.
    ...
    def _generate_qubit_ids(self) -> Dict['alphaclops.Qid', str]:
    ...
    def _write_operations(
        self,
        op_tree: 'alphaclops.OP_TREE',
        output: Callable[[str], None],
        output_line_gap: Callable[[int], None],
    ) -> None:
        def keep(op: 'alphaclops.Operation') -> bool:
