...
from alphaclops.circuits._block_diagram_drawer import BlockDiagramDrawer
from alphaclops.circuits._box_drawing_character_data import (
    BoxDrawCharacterSet,
    NORMAL_BOX_CHARS,
    BOLD_BOX_CHARS,
    ASCII_BOX_CHARS,
...
class TextDiagramDrawer:
    ...
    def transpose(self) -> 'alphaclops.TextDiagramDrawer':
    ...
    def shift(self, dx: int = 0, dy: int = 0) -> 'alphaclops.TextDiagramDrawer':
        self._transform_coordinates(lambda x, y: (x + dx, y + dy))
        return self

    def shifted(self, dx: int = 0, dy: int = 0) -> 'alphaclops.TextDiagramDrawer':
        return self.copy().shift(dx, dy)

    def superimpose(self, other: 'alphaclops.TextDiagramDrawer') -> 'alphaclops.TextDiagramDrawer':
    ...
    def superimposed(self, other: 'alphaclops.TextDiagramDrawer') -> 'alphaclops.TextDiagramDrawer':
        return self.copy().superimpose(other)

    @classmethod
    def vstack(
        cls,
        diagrams: Sequence['alphaclops.TextDiagramDrawer'],
