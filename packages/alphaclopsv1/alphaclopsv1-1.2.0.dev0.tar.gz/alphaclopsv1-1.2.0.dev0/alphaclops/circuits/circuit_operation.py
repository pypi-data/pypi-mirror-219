...
from alphaclops import circuits, ops, protocols, value, study
from alphaclops._compat import cached_property, proper_repr
...
class CircuitOperation(ops.Operation):
    ...
    def __init__(
        ...
        qubit_map: Optional[Dict['alphaclops.Qid', 'alphaclops.Qid']] = None,
        ...
        extern_keys: FrozenSet['alphaclops.MeasurementKey'] = frozenset(),
        use_repetition_ids: bool = True,
        repeat_until: Optional['alphaclops.Condition'] = None,
    ):
    ...
    @property
    def circuit(self) -> 'alphaclops.FrozenCircuit':
    ...
    @property
    def repeat_until(self) -> Optional['alphaclops.Condition']:
        return self._repeat_until

    @property
    def qubit_map(self) -> Mapping['alphaclops.Qid', 'alphaclops.Qid']:
    ...
    def base_operation(self) -> 'alphaclops.CircuitOperation':
    ...
    def replace(self, **changes) -> 'alphaclops.CircuitOperation':
    ...
    @cached_property
    def _measurement_key_objs(self) -> FrozenSet['alphaclops.MeasurementKey']:
    ...
    @cached_property
    def _control_keys(self) -> FrozenSet['alphaclops.MeasurementKey']:
        keys = (
            frozenset()
    ...
    @cached_property
    def _mapped_any_loop(self) -> 'alphaclops.Circuit':
    ...
    def _mapped_single_loop(self, repetition_id: Optional[str] = None) -> 'alphaclops.Circuit':
    ...
    def mapped_circuit(self, deep: bool = False) -> 'alphaclops.Circuit':
        ...
        Returns:
            ...
            like `alphaclops.decompose(self)`, but preserving moment structure.
        """
        self._ensure_deterministic_loop_count()
    ...
    def mapped_op(self, deep: bool = False) -> 'alphaclops.CircuitOperation':
    ...
    def _decompose_(self) -> Iterator['alphaclops.Operation']:
    ...
    def __repr__(self):
        ...
        return f'alphaclops.CircuitOperation({indented_args[:-4]})'
    ...
    def __pow__(self, power: IntParam) -> 'alphaclops.CircuitOperation':
    ...
    def with_key_path(self, path: Tuple[str, ...]):
        """Alias for `alphaclops.with_key_path(self, path)`.
    ...
    def with_repetition_ids(self, repetition_ids: List[str]) -> 'alphaclops.CircuitOperation':
    ...
    def with_qubit_mapping(
        self, qubit_map: Union[Mapping['alphaclops.Qid', 'alphaclops.Qid'], Callable[[
                'alphaclops.Qid'], 'alphaclops.Qid']]
    ...
    def with_qubits(self, *new_qubits: 'alphaclops.Qid') -> 'alphaclops.CircuitOperation':
        """Returns a copy of this operation with an updated qubit mapping.
    ...
    def with_measurement_key_mapping(self, key_map: Mapping[str, str]) -> 'alphaclops.CircuitOperation':
    ...
    def _with_measurement_key_mapping_(self, key_map: Mapping[str, str]) -> 'alphaclops.CircuitOperation':
        return self.with_measurement_key_mapping(key_map)

    def with_params(
        self, param_values: 'alphaclops.ParamResolverOrSimilarType', recursive: bool = False
    ) -> 'alphaclops.CircuitOperation':
    ...
    def _resolve_parameters_(
        ...
        return resolved.replace(
            repetitions=resolver.value_of(cast('alphaclops.TParamVal', self.repetitions), recursive)
        )
