...
from alphaclops._compat import ALLOW_DEPRECATION_IN_TEST
...
def assert_deprecated(*msgs: str, deadline: str, count: Optional[int] = 1) -> Iterator[None]:
    ...
    >>> with assert_deprecated("use alphaclops.x instead", deadline="v0.9"):
    ...
    from alphaclops.testing import assert_logs
