...
from alphaclops import devices, linalg, ops, protocols
...
"""
    ...
    try:
        ...
        raise AssertionError(
            'QASM not consistent with alphaclops.unitary(op) up to global phase.\n\n'
            'op:\n{}\n\n'
            'alphaclops.unitary(op):\n{}\n\n'
            'Generated QASM:\n\n{}\n\n'
            'Unitary of generated QASM:\n{}\n\n'
            'Phased matched alphaclops.unitary(op):\n{}\n\n'
