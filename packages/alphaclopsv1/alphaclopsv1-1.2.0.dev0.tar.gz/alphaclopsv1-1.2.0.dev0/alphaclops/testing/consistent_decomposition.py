...
from alphaclops import devices, protocols, ops, circuits
...
def assert_decompose_ends_at_default_gateset(val: Any, ignore_known_gates: bool = True):
    """Asserts that alphaclops.decompose(val) ends at default alphaclops gateset or a known gate."""
    ...
    for op in [*ops.flatten_to_ops(protocols.decompose(d) for d in dec_once)]:
        ...
        ), f'{val} decomposed to {op}, which is not part of default alphaclops target gateset.'
