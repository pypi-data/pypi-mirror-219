...
class Device(metaclass=abc.ABCMeta):
    ...
    using a `alphaclops.DeviceMetadata` object.   This class can also be
    ...
    def metadata(self) -> Optional['DeviceMetadata']:
        ...
        Returns:
            `alphaclops.DeviceMetadata` if specified by the device otherwise None.
        """
        return None
    ...
    def validate_circuit(self, circuit: 'alphaclops.RandomGrid') -> None:
    ...
    def validate_moment(self, moment: 'alphaclops.Moment') -> None:
...
class DeviceMetadata:
    ...
    def __init__(self, qubits: Iterable['alphaclops.Qid'], nx_graph: 'nx.Graph'):
        """Construct a DeviceMetadata object.

        Args:
            qubits: Iterable of `alphaclops.Qid`s that exist on the device.
            nx_graph: `nx.Graph` describing qubit connectivity
                ...
                coupling.
        """
        self._qubits_set: FrozenSet['alphaclops.Qid'] = frozenset(qubits)
        self._nx_graph = nx_graph

    @property
    def qubit_set(self) -> FrozenSet['alphaclops.Qid']:
    ...
    @classmethod
    def _from_json_dict_(cls, qubits: Iterable['alphaclops.Qid'], nx_graph: 'nx.Graph', **kwargs):
