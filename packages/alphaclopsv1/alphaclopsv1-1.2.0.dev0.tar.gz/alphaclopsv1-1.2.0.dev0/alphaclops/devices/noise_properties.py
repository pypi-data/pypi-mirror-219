...
from alphaclops import _import, ops, protocols, devices
from alphaclops.devices.noise_utils import PHYSICAL_GATE_TAG

circuits = _import.LazyLoader("circuits", globals(), "alphaclops.circuits.circuit")
...
class NoiseModelFromNoiseProperties(devices.NoiseModel):
    ...
    def is_virtual(self, op: 'alphaclops.Operation') -> bool:
