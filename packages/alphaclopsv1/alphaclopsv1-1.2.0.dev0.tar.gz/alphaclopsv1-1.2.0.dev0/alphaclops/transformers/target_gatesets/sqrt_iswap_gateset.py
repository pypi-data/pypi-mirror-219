...
from alphaclops import ops, protocols
from alphaclops.protocols.decompose_protocol import DecomposeResult
from alphaclops.transformers.analytical_decompositions import two_qubit_to_sqrt_iswap
from alphaclops.transformers.target_gatesets import compilation_target_gateset
...
class SqrtIswapTargetGateset(compilation_target_gateset.TwoQubitCompilationTargetGateset):
    ...
    By default, `alphaclops.SqrtIswapTargetGateset` will accept and compile unknown gates to
    the following universal target gateset:
    - `alphaclops.SQRT_ISWAP` / `alphaclops.SQRT_ISWAP_INV`: The two qubit entangling gate.
    - `alphaclops.PhasedXZGate`: Single qubit rotations.
    - `alphaclops.MeasurementGate`: Measurements.
    - `alphaclops.GlobalPhaseGate`: Global phase.
    ...
    this gateset, will be compiled to the default gateset (i.e. `alphaclops.SQRT_ISWAP`/
    `alphaclops.alphaclops.SQRT_ISWAP_INV`, `alphaclops.PhasedXZGate`, `alphaclops.MeasurementGate`).
    """
    ...
    def __init__(
        ...
        *,
        ...
        additional_gates: Sequence[Union[Type['alphaclops.Gate'], 'alphaclops.Gate', 'alphaclops.GateFamily']] = (),
    ):
        """Initializes `alphaclops.SqrtIswapTargetGateset`
        ...
        Args:
            ...
            use_sqrt_iswap_inv: If True, `alphaclops.SQRT_ISWAP_INV` is used as part of the gateset,
                instead of `alphaclops.SQRT_ISWAP`.
    ...
    def __repr__(self) -> str:
        return (
            f'alphaclops.SqrtIswapTargetGateset('
            f'atol={self.atol}, '
