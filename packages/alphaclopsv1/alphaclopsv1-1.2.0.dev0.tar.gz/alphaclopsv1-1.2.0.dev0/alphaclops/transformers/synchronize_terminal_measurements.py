...
from alphaclops import protocols, circuits
...
def find_terminal_measurements(
    ...
    open_qubits: Set['alphaclops.Qid'] = set(circuit.all_qubits())
    seen_control_keys: Set['alphaclops.MeasurementKey'] = set()
    terminal_measurements: Set[Tuple[int, 'alphaclops.Operation']] = set()
