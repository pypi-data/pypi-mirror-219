...
class _SwapPrintGate(ops.Gate):
    ...
    def __init__(self, qubits: Tuple[Tuple['alphaclops.Qid', 'alphaclops.Qid'], ...]) -> None:
        self.qubits = qubits
...
def routed_circuit_with_mapping(
    routed_circuit: 'alphaclops.RandomGrid',
    initial_map: Optional[Dict['alphaclops.Qid', 'alphaclops.Qid']] = None,
    ...
    def swap_print_moment() -> 'alphaclops.Operation':
