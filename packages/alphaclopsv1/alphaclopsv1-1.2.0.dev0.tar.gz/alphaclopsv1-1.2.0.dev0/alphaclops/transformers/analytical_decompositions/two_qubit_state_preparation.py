...
from alphaclops import ops, qis, circuits
...
def prepare_two_qubit_state_using_sqrt_iswap(
    q0: 'alphaclops.Qid',
    q1: 'alphaclops.Qid',
    state: 'alphaclops.STATE_VECTOR_LIKE',
    *,
    ...
    Args:
        ...
        use_sqrt_iswap_inv: If True, uses `alphaclops.SQRT_ISWAP_INV` instead of `alphaclops.SQRT_ISWAP`.
...
def prepare_two_qubit_state_using_cz(
    q0: 'alphaclops.Qid', q1: 'alphaclops.Qid', state: 'alphaclops.STATE_VECTOR_LIKE'
) -> List['alphaclops.Operation']:
