...
def document(value: Any, doc_string: str = ''):
    ...
    `alphaclops._doc.RECORDED_CONST_DOCS`.
    ...
    try:
        ...
        # API docs. See https://github.com/quantumlib/alphaclops/issues/3276 for
        # more info.

        # to list them, uncomment these lines and run `import alphaclops`:
        # print(f"WARNING: {e}")
