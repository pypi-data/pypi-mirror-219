...
from alphaclops.interop.quirk.cells.cell import Cell, CellMaker, CELL_SIZES
...
class ArithmeticCell(Cell):
    def __init__(
        self,
        identifier: str,
        target: Sequence['alphaclops.Qid'],
        inputs: Sequence[Union[None, Sequence['alphaclops.Qid'], int]],
    ):
        self.identifier = identifier
    ...
    def __repr__(self) -> str:
        return (
            f'alphaclops.interop.quirk.cells.arithmetic_cells.ArithmeticCell('
            f'\n    {self.identifier!r},'
            f'\n    {self.target!r},'
            f'\n    {self.inputs!r})'
        )
    ...
    def with_input(
        self, letter: str, register: Union[Sequence['alphaclops.Qid'], int]
    ) -> 'ArithmeticCell':
        new_inputs = [
    ...
    def operations(self) -> 'alphaclops.OP_TREE':
        ...
        inputs = cast(Sequence[Union[Sequence['alphaclops.Qid'], int]], self.inputs)
