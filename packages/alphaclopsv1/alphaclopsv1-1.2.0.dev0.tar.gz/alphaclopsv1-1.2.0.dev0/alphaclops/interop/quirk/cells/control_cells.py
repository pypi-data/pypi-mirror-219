...
from alphaclops import ops, value
...
class ControlCell(Cell):
    ...
    def __init__(self, qubit: 'alphaclops.Qid', basis_change: Iterable['alphaclops.Operation']):
        self.qubit = qubit
    ...
    def __repr__(self) -> str:
        return (
            f'alphaclops.interop.quirk.cells.control_cells.ControlCell('
            f'\n    {self.qubit!r},'
...
class ParityControlCell(Cell):
    ...
    def __init__(self, qubits: Iterable['alphaclops.Qid'], basis_change: Iterable['alphaclops.Operation']):
    ...
    def __repr__(self) -> str:
        return (
            f'alphaclops.interop.quirk.cells.control_cells.ParityControlCell('
            f'\n    {self.qubits!r},'
            f'\n    {self._basis_change!r})'
        )
...
def _reg_control(identifier: str, *, basis_change: Optional['alphaclops.Gate']) -> CellMaker:
    return CellMaker(
...
def _reg_parity_control(
    identifier: str, *, basis_change: Optional['alphaclops.Gate'] = None
) -> CellMaker:
    return CellMaker(
        identifier=identifier,
        size=1,
...
def _basis_else_empty(
    basis_change: Optional['alphaclops.Gate'], qureg: Union['alphaclops.Qid', Iterable['alphaclops.Qid']]
