...
from alphaclops.value import big_endian_int_to_digits, random_state
...
class StabilizerStateChForm(qis.StabilizerState):
    ...
    def copy(self, deep_copy_buffers: bool = True) -> 'alphaclops.StabilizerStateChForm':
    ...
    def __str__(self) -> str:
        ...
        return alphaclops.dirac_notation(self.to_state_vector())
    ...
    def inner_product_of_state_and_x(self, x: int) -> Union[float, complex]:
        ...
        if type(x) == int:
            y = alphaclops.big_endian_int_to_bits(x, bit_count=self.n)
    ...
    def kron(self, other: 'alphaclops.StabilizerStateChForm') -> 'alphaclops.StabilizerStateChForm':
        n = self.n + other.n
        copy = StabilizerStateChForm(n)
    ...
    def reindex(self, axes: Sequence[int]) -> 'alphaclops.StabilizerStateChForm':
        copy = StabilizerStateChForm(self.n)
