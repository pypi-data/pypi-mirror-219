...
class SimulationProductState(
    ...
    def __init__(
        self,
        sim_states: Dict[Optional['alphaclops.Qid'], TSimulationState],
    ...
    @property
    def sim_states(self) -> Mapping[Optional['alphaclops.Qid'], TSimulationState]:
    ...
    ) -> 'alphaclops.SimulationProductState[TSimulationState]':
