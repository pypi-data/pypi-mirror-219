...
from alphaclops import linalg, protocols, qis, sim
from alphaclops._compat import proper_repr
from alphaclops.linalg import transformations
from alphaclops.sim.simulation_state import SimulationState, strat_act_on_from_apply_decompose
...
class _BufferedStateVector(qis.QuantumStateRepresentation):
    ...
    def create(
        cls,
        *,
        initial_state: Union[np.ndarray, 'alphaclops.STATE_VECTOR_LIKE'] = 0,
    ...
    def _swap_target_tensor_for(self, new_target_tensor: np.ndarray):
        ...
        `args` is this `alphaclops.StateVectorSimulationState` instance.
...
class StateVectorSimulationState(SimulationState[_BufferedStateVector]):
    ...
    def add_qubits(self, qubits: Sequence['alphaclops.Qid']):
    ...
    def remove_qubits(self, qubits: Sequence['alphaclops.Qid']):
    ...
    def _act_on_fallback_(
        ...
        strats: List[Callable[[Any, Any, Sequence['alphaclops.Qid']], bool]] = [
    ...
    def __repr__(self) -> str:
        return (
            'alphaclops.StateVectorSimulationState('
...
def _strat_act_on_state_vector_from_apply_unitary(
    action: Any, args: 'alphaclops.StateVectorSimulationState', qubits: Sequence['alphaclops.Qid']
) -> bool:
