...
"""Batteries-included class for alphaclops's built-in simulators."""
...
from alphaclops import devices, ops, protocols, study, value
...
class SimulatorBase(
    ...
    @property
    def noise(self) -> 'alphaclops.NoiseModel':
        return self._noise
    ...
    def _core_iterator(
        ...
        measured: Dict[Tuple['alphaclops.Qid', ...], bool] = collections.defaultdict(bool)
    ...
    def _run(
        ...
        """See definition in `alphaclops.SimulatesSamples`."""
        ...
        records: Dict['alphaclops.MeasurementKey', List[Sequence[Sequence[int]]]] = {}
    ...
    def simulate_sweep_iter(
        ...
        def sweep_prefixable(op: 'alphaclops.Operation'):
    ...
    def _create_simulation_state(
        self, initial_state: Any, qubits: Sequence['alphaclops.Qid']
        ...
        if self._split_untangled_states:
            args_map: Dict[Optional['alphaclops.Qid'], TSimulationState] = {}
...
class SimulationTrialResultBase(
    ...
    def get_state_containing_qubit(self, qubit: 'alphaclops.Qid') -> TSimulationState:
