...
class V1NetworkPolicy:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ..., spec: typing.Optional[kubernetes.client.V1NetworkPolicySpec] = ..., status: typing.Optional[kubernetes.client.V1NetworkPolicyStatus] = ...) -> None:
        ...
