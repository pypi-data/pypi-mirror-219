...
class EngineAdapterStateSync(CommonStateSyncMixin, StateSync):
    ...
    def __init__(
        ...
        self.snapshots_table = f"_snapshots"
        self.environments_table = f"_environments"
        self.seeds_table = f"_seeds"
        self.intervals_table = f"_intervals"
        self.versions_table = f"_versions"
