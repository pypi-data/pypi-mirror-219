...
from selenium_profiles_brand.utils.colab_utils import is_colab
from selenium_profiles_brand.scripts.profiles import options as options_handler
...
class Chrome(BaseDriver):
    ...
    def __init__(self, profile: dict = None, chrome_binary: str = None, executable_path: str = None,
        ...
        from selenium_profiles_brand.utils.utils import valid_key
        ...
        if (uc_webdriver.Chrome in base_drivers) or (wire_uc_webdriver.Chrome in base_drivers):
            ...
            from selenium_profiles_brand.scripts import undetected
...
class profiles:
    ...
    def __init__(self, driver, profile, cdp_handler=None, selenium_injector=None):
        ...
        from selenium_profiles_brand.scripts.driver_utils import requests, actions
        from selenium_profiles_brand.scripts.proxy import DynamicProxy
        ...
        if cdp_handler:
            ...
            from selenium_profiles_brand.scripts.profiles import cdp_handler
    ...
    def get_profile(self):
        from selenium_profiles_brand.utils.utils import read
