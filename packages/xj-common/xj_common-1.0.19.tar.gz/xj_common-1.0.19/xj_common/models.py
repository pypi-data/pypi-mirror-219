...
class AppVersion(models.Model):
    ...
    version_type = models.CharField(null=True, max_length=255, choices=version_type_choices, blank=True, verbose_name='是否强制更新')
    store_name = models.CharField(null=True, max_length=255, blank=True, verbose_name='渠道名')
    store_url = models.CharField(null=True, max_length=5000, blank=True, verbose_name='渠道商跳转路由')
    version_detail = models.CharField(null=True, max_length=10000, blank=True, verbose_name='更新内容')
    is_force_update = models.IntegerField(null=True, default=0, blank=True, verbose_name='是否强制更新')
    push_time = models.DateTimeField(null=True, blank=True, auto_now_add=True, verbose_name='推送时间')
