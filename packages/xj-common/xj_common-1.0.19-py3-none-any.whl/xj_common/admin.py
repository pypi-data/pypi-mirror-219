...
class AppVersionAdmin(admin.ModelAdmin):
    list_display = ("id", "app_system", "version", "version_type", "store_name", "store_url", "is_force_update", "push_time", "created_time")
    search_fields = ("id", "app_system", "version", "version_type", "store_name", "store_url", "is_force_update", "push_time", "created_time")
    fields = ("id", "app_system", "version", "version_type", "store_name", "store_url", "is_force_update", "push_time", "created_time")
    readonly_fields = ['id', "created_time"]
    list_per_page = 20
