...
class MarketDatabase:
    ...
    _GET_ITEM_ALIAS_QUERY: str = "SELECT alias FROM item_aliases WHERE item_id=%s"
    ...
    def get_item_aliases(self, item_id: str) -> Tuple[Tuple[Any, ...], ...]:
        return self._execute_query(self._GET_ITEM_ALIAS_QUERY, item_id).fetchall()

    def add_item_alias(self, item_id, alias):
        self._execute_query(self._ADD_ITEM_ALIAS_QUERY, item_id, alias)
        self.connection.commit()

    def remove_item_alias(self, item_id, alias):
        self._execute_query(self._REMOVE_ITEM_ALIAS_QUERY, item_id, alias)
        self.connection.commit()

    def add_word_alias(self, word, alias):
        self._execute_query(self._ADD_WORD_ALIAS_QUERY, word, alias)
        self.connection.commit()
...
class MarketItem:
    ...
    def get_aliases(self) -> Tuple[Tuple[Any, ...], ...]:
        return self.database.get_item_aliases(self.item_id)
