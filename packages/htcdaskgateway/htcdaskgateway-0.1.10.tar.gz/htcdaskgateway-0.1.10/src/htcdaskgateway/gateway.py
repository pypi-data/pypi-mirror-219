...
class HTCGateway(Gateway):
    ...
    def __init__(self, **kwargs):
        addr = kwargs.pop('address', 'http://172.30.92.196')
        public_addr = kwargs.pop('public_address', 'https://dask-gateway.fnal.gov')
        super().__init__(address=addr, public_address=public_addr auth="jupyterhub", **kwargs)
