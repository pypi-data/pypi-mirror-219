...
class FirMemOp(_ods_ir.OpView):
  ...
  def readLatency(self):
    return _ods_ir.IntegerAttr(self.operation.attributes["readLatency"])
  ...
  def writeLatency(self):
    return _ods_ir.IntegerAttr(self.operation.attributes["writeLatency"])
  ...
  def prefix(self):
    if "prefix" not in self.operation.attributes:
      return None
    return _ods_ir.StringAttr(self.operation.attributes["prefix"])
  ...
  def output_file(self):
    if "output_file" not in self.operation.attributes:
      return None
    return _ods_ir.Attribute(self.operation.attributes["output_file"])
