...
class PowerTransform(PALBase):
    ...
    nomially :math:`\lambda`.

    Box-Cox transformation is resctricted to positive data only, with mathematically formula
    illustrated as follows:
    ...
    tol : float, optional
        ...
        :math:`\lambda`. The value shoud be positive but less than 1.
    ...
    ----------
    model_ : DataFrame
        DataFrame containing the model info for power transformation, structued as follows:
    ...
    def fit(self, data, key=None, features=None, feature_interval=None, feature_interval_hint=None):
        ...
        key : str, optional
            ...
            it ``key`` must be specified expicitly(i.e. mandatory).
    ...
    def fit_transform(self, data, key=None, features=None, feature_interval=None, feature_interval_hint=None):
        ...
        key : str, optional
            ...
            Defaults to the index of ``data`` if ``data`` is indexed by a single column, otherwise
            ``key`` must be specified expicitly(i.e. mandatory).
    ...
    def transform(self, data, key=None, features=None,
        ...
        inverse : bool, optional
            Speficies whether or not to apply inverse power transform.
