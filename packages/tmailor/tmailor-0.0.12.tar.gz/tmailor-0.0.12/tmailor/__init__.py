...
latestVersion = get(
 "https://pypi.org/pypi/tmailor/json").json()["info"]["version"]

if __version__ != latestVersion:
	print(
	 f"{Fore.RED}WARNING:{Style.RESET_ALL} You are using an outdated version of tmailor ({__version__}). The latest version is {latestVersion}."
	)
