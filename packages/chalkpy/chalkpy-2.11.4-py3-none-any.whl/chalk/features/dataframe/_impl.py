                ...
                for row in data:
                    ...
                    for x in row.features:
                        ...
                        try:
                            ...
                            continue
                        # TODO (rkargon) remove this once has-many encoder/decoder works
                        if x.is_has_many:
        ...
        for row in self.to_pyarrow().to_pylist():
            ...
            for rooted_prefix in sorted_sub_features:
                ...
                for k, v in values.items():
                    ...
                    # TODO (rkargon) remove this once has-many DF encoder/decoder support works
                    assert not feature.is_has_many, (
                        "Extracting has-many features from a Chalk DataFrame is not currently supported. "
                        "Please use DataFrame.to_polars() to work with the underlying Polars DataFrame."
                    )
