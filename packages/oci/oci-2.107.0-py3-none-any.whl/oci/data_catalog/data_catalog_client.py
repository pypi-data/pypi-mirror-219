...
class DataCatalogClient(object):
    ...
    def add_data_selector_patterns(self, catalog_id, data_asset_key, data_selector_pattern_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/add_data_selector_patterns.py.html>`__ to see an example of how to use add_data_selector_patterns API.
        """
    ...
    def associate_custom_property(self, catalog_id, type_key, associate_custom_property_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/associate_custom_property.py.html>`__ to see an example of how to use associate_custom_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def attach_catalog_private_endpoint(self, attach_catalog_private_endpoint_details, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/attach_catalog_private_endpoint.py.html>`__ to see an example of how to use attach_catalog_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_catalog_compartment(self, change_catalog_compartment_details, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/change_catalog_compartment.py.html>`__ to see an example of how to use change_catalog_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def change_catalog_private_endpoint_compartment(self, change_catalog_private_endpoint_compartment_details, catalog_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/change_catalog_private_endpoint_compartment.py.html>`__ to see an example of how to use change_catalog_private_endpoint_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_metastore_compartment(self, change_metastore_compartment_details, metastore_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/change_metastore_compartment.py.html>`__ to see an example of how to use change_metastore_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_attribute(self, catalog_id, data_asset_key, entity_key, create_attribute_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_attribute.py.html>`__ to see an example of how to use create_attribute API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_attribute_tag(self, catalog_id, data_asset_key, entity_key, attribute_key, create_attribute_tag_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_attribute_tag.py.html>`__ to see an example of how to use create_attribute_tag API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_catalog(self, create_catalog_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_catalog.py.html>`__ to see an example of how to use create_catalog API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_catalog_private_endpoint(self, create_catalog_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_catalog_private_endpoint.py.html>`__ to see an example of how to use create_catalog_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_connection(self, catalog_id, data_asset_key, create_connection_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_connection.py.html>`__ to see an example of how to use create_connection API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
    ...
    def create_custom_property(self, catalog_id, namespace_id, create_custom_property_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_custom_property.py.html>`__ to see an example of how to use create_custom_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_data_asset(self, catalog_id, create_data_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_data_asset.py.html>`__ to see an example of how to use create_data_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def create_data_asset_tag(self, catalog_id, data_asset_key, create_data_asset_tag_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_data_asset_tag.py.html>`__ to see an example of how to use create_data_asset_tag API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
    ...
    def create_entity(self, catalog_id, data_asset_key, create_entity_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_entity.py.html>`__ to see an example of how to use create_entity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
    ...
    def create_entity_tag(self, catalog_id, data_asset_key, entity_key, create_entity_tag_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_entity_tag.py.html>`__ to see an example of how to use create_entity_tag API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey']
    ...
    def create_folder(self, catalog_id, data_asset_key, create_folder_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_folder.py.html>`__ to see an example of how to use create_folder API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
    ...
    def create_folder_tag(self, catalog_id, data_asset_key, folder_key, create_folder_tag_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_folder_tag.py.html>`__ to see an example of how to use create_folder_tag API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_glossary(self, catalog_id, create_glossary_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_glossary.py.html>`__ to see an example of how to use create_glossary API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def create_job(self, catalog_id, create_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_job.py.html>`__ to see an example of how to use create_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def create_job_definition(self, catalog_id, create_job_definition_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_job_definition.py.html>`__ to see an example of how to use create_job_definition API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def create_job_execution(self, catalog_id, job_key, create_job_execution_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_job_execution.py.html>`__ to see an example of how to use create_job_execution API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_metastore(self, create_metastore_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_metastore.py.html>`__ to see an example of how to use create_metastore API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_namespace(self, catalog_id, create_namespace_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_namespace.py.html>`__ to see an example of how to use create_namespace API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def create_pattern(self, catalog_id, create_pattern_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_pattern.py.html>`__ to see an example of how to use create_pattern API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def create_term(self, catalog_id, glossary_key, create_term_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_term.py.html>`__ to see an example of how to use create_term API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_term_relationship(self, catalog_id, glossary_key, term_key, create_term_relationship_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/create_term_relationship.py.html>`__ to see an example of how to use create_term_relationship API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_attribute(self, catalog_id, data_asset_key, entity_key, attribute_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_attribute.py.html>`__ to see an example of how to use delete_attribute API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey', 'attributeKey']
    ...
    def delete_attribute_tag(self, catalog_id, data_asset_key, entity_key, attribute_key, tag_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_attribute_tag.py.html>`__ to see an example of how to use delete_attribute_tag API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_catalog(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_catalog.py.html>`__ to see an example of how to use delete_catalog API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def delete_catalog_private_endpoint(self, catalog_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_catalog_private_endpoint.py.html>`__ to see an example of how to use delete_catalog_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogPrivateEndpointId']
    ...
    def delete_connection(self, catalog_id, data_asset_key, connection_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_connection.py.html>`__ to see an example of how to use delete_connection API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_custom_property(self, catalog_id, namespace_id, custom_property_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_custom_property.py.html>`__ to see an example of how to use delete_custom_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_data_asset(self, catalog_id, data_asset_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_data_asset.py.html>`__ to see an example of how to use delete_data_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
    ...
    def delete_data_asset_tag(self, catalog_id, data_asset_key, tag_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_data_asset_tag.py.html>`__ to see an example of how to use delete_data_asset_tag API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_entity(self, catalog_id, data_asset_key, entity_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_entity.py.html>`__ to see an example of how to use delete_entity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey']
    ...
    def delete_entity_tag(self, catalog_id, data_asset_key, entity_key, tag_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_entity_tag.py.html>`__ to see an example of how to use delete_entity_tag API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_folder(self, catalog_id, data_asset_key, folder_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_folder.py.html>`__ to see an example of how to use delete_folder API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'folderKey']
    ...
    def delete_folder_tag(self, catalog_id, data_asset_key, folder_key, tag_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_folder_tag.py.html>`__ to see an example of how to use delete_folder_tag API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_glossary(self, catalog_id, glossary_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_glossary.py.html>`__ to see an example of how to use delete_glossary API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey']
    ...
    def delete_job(self, catalog_id, job_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_job.py.html>`__ to see an example of how to use delete_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'jobKey']
    ...
    def delete_job_definition(self, catalog_id, job_definition_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_job_definition.py.html>`__ to see an example of how to use delete_job_definition API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_metastore(self, metastore_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_metastore.py.html>`__ to see an example of how to use delete_metastore API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['metastoreId']
    ...
    def delete_namespace(self, catalog_id, namespace_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_namespace.py.html>`__ to see an example of how to use delete_namespace API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'namespaceId']
    ...
    def delete_pattern(self, catalog_id, pattern_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_pattern.py.html>`__ to see an example of how to use delete_pattern API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_term(self, catalog_id, glossary_key, term_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_term.py.html>`__ to see an example of how to use delete_term API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey', 'termKey']
    ...
    def delete_term_relationship(self, catalog_id, glossary_key, term_key, term_relationship_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/delete_term_relationship.py.html>`__ to see an example of how to use delete_term_relationship API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def detach_catalog_private_endpoint(self, detach_catalog_private_endpoint_details, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/detach_catalog_private_endpoint.py.html>`__ to see an example of how to use detach_catalog_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def disassociate_custom_property(self, catalog_id, type_key, disassociate_custom_property_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/disassociate_custom_property.py.html>`__ to see an example of how to use disassociate_custom_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'typeKey']
    ...
    def expand_tree_for_glossary(self, catalog_id, glossary_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/expand_tree_for_glossary.py.html>`__ to see an example of how to use expand_tree_for_glossary API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey']
    ...
    def export_glossary(self, catalog_id, glossary_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/export_glossary.py.html>`__ to see an example of how to use export_glossary API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey']
    ...
    def get_attribute(self, catalog_id, data_asset_key, entity_key, attribute_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_attribute.py.html>`__ to see an example of how to use get_attribute API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey', 'attributeKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/entities/{entityKey}/attributes/{attributeKey}"
    ...
    def get_attribute_tag(self, catalog_id, data_asset_key, entity_key, attribute_key, tag_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_attribute_tag.py.html>`__ to see an example of how to use get_attribute_tag API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey', 'attributeKey', 'tagKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/entities/{entityKey}/attributes/{attributeKey}/tags/{tagKey}"
    ...
    def get_catalog(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_catalog.py.html>`__ to see an example of how to use get_catalog API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
        resource_path = "/catalogs/{catalogId}"
    ...
    def get_catalog_private_endpoint(self, catalog_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_catalog_private_endpoint.py.html>`__ to see an example of how to use get_catalog_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogPrivateEndpointId']
        resource_path = "/catalogPrivateEndpoints/{catalogPrivateEndpointId}"
    ...
    def get_connection(self, catalog_id, data_asset_key, connection_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_connection.py.html>`__ to see an example of how to use get_connection API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'connectionKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/connections/{connectionKey}"
    ...
    def get_custom_property(self, catalog_id, namespace_id, custom_property_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_custom_property.py.html>`__ to see an example of how to use get_custom_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'namespaceId', 'customPropertyKey']
        resource_path = "/catalogs/{catalogId}/namespaces/{namespaceId}/customProperties/{customPropertyKey}"
    ...
    def get_data_asset(self, catalog_id, data_asset_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_data_asset.py.html>`__ to see an example of how to use get_data_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}"
    ...
    def get_data_asset_tag(self, catalog_id, data_asset_key, tag_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_data_asset_tag.py.html>`__ to see an example of how to use get_data_asset_tag API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'tagKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/tags/{tagKey}"
    ...
    def get_entity(self, catalog_id, data_asset_key, entity_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_entity.py.html>`__ to see an example of how to use get_entity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/entities/{entityKey}"
    ...
    def get_entity_tag(self, catalog_id, data_asset_key, entity_key, tag_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_entity_tag.py.html>`__ to see an example of how to use get_entity_tag API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey', 'tagKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/entities/{entityKey}/tags/{tagKey}"
    ...
    def get_folder(self, catalog_id, data_asset_key, folder_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_folder.py.html>`__ to see an example of how to use get_folder API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'folderKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/folders/{folderKey}"
    ...
    def get_folder_tag(self, catalog_id, data_asset_key, folder_key, tag_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_folder_tag.py.html>`__ to see an example of how to use get_folder_tag API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'folderKey', 'tagKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/folders/{folderKey}/tags/{tagKey}"
    ...
    def get_glossary(self, catalog_id, glossary_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_glossary.py.html>`__ to see an example of how to use get_glossary API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey']
        resource_path = "/catalogs/{catalogId}/glossaries/{glossaryKey}"
    ...
    def get_job(self, catalog_id, job_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_job.py.html>`__ to see an example of how to use get_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'jobKey']
        resource_path = "/catalogs/{catalogId}/jobs/{jobKey}"
    ...
    def get_job_definition(self, catalog_id, job_definition_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_job_definition.py.html>`__ to see an example of how to use get_job_definition API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'jobDefinitionKey']
        resource_path = "/catalogs/{catalogId}/jobDefinitions/{jobDefinitionKey}"
    ...
    def get_job_execution(self, catalog_id, job_key, job_execution_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_job_execution.py.html>`__ to see an example of how to use get_job_execution API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_job_log(self, catalog_id, job_key, job_execution_key, job_log_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_job_log.py.html>`__ to see an example of how to use get_job_log API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_job_metrics(self, catalog_id, job_key, job_execution_key, job_metrics_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_job_metrics.py.html>`__ to see an example of how to use get_job_metrics API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_metastore(self, metastore_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_metastore.py.html>`__ to see an example of how to use get_metastore API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['metastoreId']
        resource_path = "/metastores/{metastoreId}"
    ...
    def get_namespace(self, catalog_id, namespace_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_namespace.py.html>`__ to see an example of how to use get_namespace API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'namespaceId']
        resource_path = "/catalogs/{catalogId}/namespaces/{namespaceId}"
    ...
    def get_pattern(self, catalog_id, pattern_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_pattern.py.html>`__ to see an example of how to use get_pattern API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'patternKey']
        resource_path = "/catalogs/{catalogId}/patterns/{patternKey}"
    ...
    def get_term(self, catalog_id, glossary_key, term_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_term.py.html>`__ to see an example of how to use get_term API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey', 'termKey']
        resource_path = "/catalogs/{catalogId}/glossaries/{glossaryKey}/terms/{termKey}"
    ...
    def get_term_relationship(self, catalog_id, glossary_key, term_key, term_relationship_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_term_relationship.py.html>`__ to see an example of how to use get_term_relationship API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey', 'termKey', 'termRelationshipKey']
        resource_path = "/catalogs/{catalogId}/glossaries/{glossaryKey}/terms/{termKey}/termRelationships/{termRelationshipKey}"
    ...
    def get_type(self, catalog_id, type_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_type.py.html>`__ to see an example of how to use get_type API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'typeKey']
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def import_connection(self, catalog_id, data_asset_key, import_connection_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/import_connection.py.html>`__ to see an example of how to use import_connection API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
    ...
    def import_data_asset(self, catalog_id, data_asset_key, import_data_asset_details, import_type, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/import_data_asset.py.html>`__ to see an example of how to use import_data_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def import_glossary(self, catalog_id, glossary_key, import_glossary_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/import_glossary.py.html>`__ to see an example of how to use import_glossary API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey']
    ...
    def list_aggregated_physical_entities(self, catalog_id, data_asset_key, entity_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_aggregated_physical_entities.py.html>`__ to see an example of how to use list_aggregated_physical_entities API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey']
    ...
    def list_attribute_tags(self, catalog_id, data_asset_key, entity_key, attribute_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_attribute_tags.py.html>`__ to see an example of how to use list_attribute_tags API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey', 'attributeKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/entities/{entityKey}/attributes/{attributeKey}/tags"
    ...
    def list_attributes(self, catalog_id, data_asset_key, entity_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_attributes.py.html>`__ to see an example of how to use list_attributes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/entities/{entityKey}/attributes"
    ...
    def list_catalog_private_endpoints(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_catalog_private_endpoints.py.html>`__ to see an example of how to use list_catalog_private_endpoints API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_catalogs(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_catalogs.py.html>`__ to see an example of how to use list_catalogs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/catalogs"
    ...
    def list_connections(self, catalog_id, data_asset_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_connections.py.html>`__ to see an example of how to use list_connections API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/connections"
    ...
    def list_custom_properties(self, catalog_id, namespace_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_custom_properties.py.html>`__ to see an example of how to use list_custom_properties API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'namespaceId']
        resource_path = "/catalogs/{catalogId}/namespaces/{namespaceId}/customProperties"
    ...
    def list_data_asset_tags(self, catalog_id, data_asset_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_data_asset_tags.py.html>`__ to see an example of how to use list_data_asset_tags API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/tags"
    ...
    def list_data_assets(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_data_assets.py.html>`__ to see an example of how to use list_data_assets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
        resource_path = "/catalogs/{catalogId}/dataAssets"
    ...
    def list_derived_logical_entities(self, catalog_id, pattern_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_derived_logical_entities.py.html>`__ to see an example of how to use list_derived_logical_entities API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'patternKey']
    ...
    def list_entities(self, catalog_id, data_asset_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_entities.py.html>`__ to see an example of how to use list_entities API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/entities"
    ...
    def list_entity_tags(self, catalog_id, data_asset_key, entity_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_entity_tags.py.html>`__ to see an example of how to use list_entity_tags API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/entities/{entityKey}/tags"
    ...
    def list_folder_tags(self, catalog_id, data_asset_key, folder_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_folder_tags.py.html>`__ to see an example of how to use list_folder_tags API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'folderKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/folders/{folderKey}/tags"
    ...
    def list_folders(self, catalog_id, data_asset_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_folders.py.html>`__ to see an example of how to use list_folders API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/folders"
    ...
    def list_glossaries(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_glossaries.py.html>`__ to see an example of how to use list_glossaries API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
        resource_path = "/catalogs/{catalogId}/glossaries"
    ...
    def list_job_definitions(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_job_definitions.py.html>`__ to see an example of how to use list_job_definitions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
        resource_path = "/catalogs/{catalogId}/jobDefinitions"
    ...
    def list_job_executions(self, catalog_id, job_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_job_executions.py.html>`__ to see an example of how to use list_job_executions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'jobKey']
        resource_path = "/catalogs/{catalogId}/jobs/{jobKey}/executions"
    ...
    def list_job_logs(self, catalog_id, job_key, job_execution_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_job_logs.py.html>`__ to see an example of how to use list_job_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'jobKey', 'jobExecutionKey']
    ...
    def list_job_metrics(self, catalog_id, job_key, job_execution_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_job_metrics.py.html>`__ to see an example of how to use list_job_metrics API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'jobKey', 'jobExecutionKey']
    ...
    def list_jobs(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_jobs.py.html>`__ to see an example of how to use list_jobs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
        resource_path = "/catalogs/{catalogId}/jobs"
    ...
    def list_metastores(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_metastores.py.html>`__ to see an example of how to use list_metastores API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/metastores"
    ...
    def list_namespaces(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_namespaces.py.html>`__ to see an example of how to use list_namespaces API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
        resource_path = "/catalogs/{catalogId}/namespaces"
    ...
    def list_patterns(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_patterns.py.html>`__ to see an example of how to use list_patterns API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
        resource_path = "/catalogs/{catalogId}/patterns"
    ...
    def list_rules(self, catalog_id, data_asset_key, entity_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_rules.py.html>`__ to see an example of how to use list_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey']
    ...
    def list_tags(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_tags.py.html>`__ to see an example of how to use list_tags API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def list_term_relationships(self, catalog_id, glossary_key, term_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_term_relationships.py.html>`__ to see an example of how to use list_term_relationships API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey', 'termKey']
        resource_path = "/catalogs/{catalogId}/glossaries/{glossaryKey}/terms/{termKey}/termRelationships"
    ...
    def list_terms(self, catalog_id, glossary_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_terms.py.html>`__ to see an example of how to use list_terms API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey']
        resource_path = "/catalogs/{catalogId}/glossaries/{glossaryKey}/terms"
    ...
    def list_types(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_types.py.html>`__ to see an example of how to use list_types API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def object_stats(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/object_stats.py.html>`__ to see an example of how to use object_stats API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def parse_connection(self, catalog_id, data_asset_key, parse_connection_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/parse_connection.py.html>`__ to see an example of how to use parse_connection API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
    ...
    def process_recommendation(self, catalog_id, process_recommendation_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/process_recommendation.py.html>`__ to see an example of how to use process_recommendation API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def recommendations(self, catalog_id, recommendation_type, source_object_key, source_object_type, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/recommendations.py.html>`__ to see an example of how to use recommendations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def remove_data_selector_patterns(self, catalog_id, data_asset_key, data_selector_pattern_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/remove_data_selector_patterns.py.html>`__ to see an example of how to use remove_data_selector_patterns API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
    ...
    def search_criteria(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/search_criteria.py.html>`__ to see an example of how to use search_criteria API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def suggest_matches(self, catalog_id, input_text, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/suggest_matches.py.html>`__ to see an example of how to use suggest_matches API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def synchronous_export_data_asset(self, catalog_id, data_asset_key, synchronous_export_data_asset_details, export_type, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/synchronous_export_data_asset.py.html>`__ to see an example of how to use synchronous_export_data_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def test_connection(self, catalog_id, data_asset_key, connection_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/test_connection.py.html>`__ to see an example of how to use test_connection API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'connectionKey']
    ...
    def update_attribute(self, catalog_id, data_asset_key, entity_key, attribute_key, update_attribute_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_attribute.py.html>`__ to see an example of how to use update_attribute API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey', 'attributeKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/entities/{entityKey}/attributes/{attributeKey}"
    ...
    def update_catalog(self, catalog_id, update_catalog_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_catalog.py.html>`__ to see an example of how to use update_catalog API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
        resource_path = "/catalogs/{catalogId}"
    ...
    def update_catalog_private_endpoint(self, catalog_private_endpoint_id, update_catalog_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_catalog_private_endpoint.py.html>`__ to see an example of how to use update_catalog_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogPrivateEndpointId']
        resource_path = "/catalogPrivateEndpoints/{catalogPrivateEndpointId}"
    ...
    def update_connection(self, catalog_id, data_asset_key, connection_key, update_connection_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_connection.py.html>`__ to see an example of how to use update_connection API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'connectionKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/connections/{connectionKey}"
    ...
    def update_custom_property(self, catalog_id, namespace_id, custom_property_key, update_custom_property_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_custom_property.py.html>`__ to see an example of how to use update_custom_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'namespaceId', 'customPropertyKey']
        resource_path = "/catalogs/{catalogId}/namespaces/{namespaceId}/customProperties/{customPropertyKey}"
    ...
    def update_data_asset(self, catalog_id, data_asset_key, update_data_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_data_asset.py.html>`__ to see an example of how to use update_data_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}"
    ...
    def update_entity(self, catalog_id, data_asset_key, entity_key, update_entity_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_entity.py.html>`__ to see an example of how to use update_entity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'entityKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/entities/{entityKey}"
    ...
    def update_folder(self, catalog_id, data_asset_key, folder_key, update_folder_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_folder.py.html>`__ to see an example of how to use update_folder API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'folderKey']
        resource_path = "/catalogs/{catalogId}/dataAssets/{dataAssetKey}/folders/{folderKey}"
    ...
    def update_glossary(self, catalog_id, glossary_key, update_glossary_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_glossary.py.html>`__ to see an example of how to use update_glossary API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey']
        resource_path = "/catalogs/{catalogId}/glossaries/{glossaryKey}"
    ...
    def update_job(self, catalog_id, job_key, update_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_job.py.html>`__ to see an example of how to use update_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'jobKey']
        resource_path = "/catalogs/{catalogId}/jobs/{jobKey}"
    ...
    def update_job_definition(self, catalog_id, job_definition_key, update_job_definition_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_job_definition.py.html>`__ to see an example of how to use update_job_definition API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'jobDefinitionKey']
        resource_path = "/catalogs/{catalogId}/jobDefinitions/{jobDefinitionKey}"
    ...
    def update_metastore(self, metastore_id, update_metastore_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_metastore.py.html>`__ to see an example of how to use update_metastore API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['metastoreId']
        resource_path = "/metastores/{metastoreId}"
    ...
    def update_namespace(self, catalog_id, namespace_id, update_namespace_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_namespace.py.html>`__ to see an example of how to use update_namespace API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'namespaceId']
        resource_path = "/catalogs/{catalogId}/namespaces/{namespaceId}"
    ...
    def update_pattern(self, catalog_id, pattern_key, update_pattern_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_pattern.py.html>`__ to see an example of how to use update_pattern API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'patternKey']
        resource_path = "/catalogs/{catalogId}/patterns/{patternKey}"
    ...
    def update_term(self, catalog_id, glossary_key, term_key, update_term_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_term.py.html>`__ to see an example of how to use update_term API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey', 'termKey']
        resource_path = "/catalogs/{catalogId}/glossaries/{glossaryKey}/terms/{termKey}"
    ...
    def update_term_relationship(self, catalog_id, glossary_key, term_key, term_relationship_key, update_term_relationship_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/update_term_relationship.py.html>`__ to see an example of how to use update_term_relationship API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'glossaryKey', 'termKey', 'termRelationshipKey']
        resource_path = "/catalogs/{catalogId}/glossaries/{glossaryKey}/terms/{termKey}/termRelationships/{termRelationshipKey}"
    ...
    def upload_credentials(self, catalog_id, data_asset_key, connection_key, upload_credentials_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/upload_credentials.py.html>`__ to see an example of how to use upload_credentials API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey', 'connectionKey']
    ...
    def users(self, catalog_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/users.py.html>`__ to see an example of how to use users API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId']
    ...
    def validate_connection(self, catalog_id, data_asset_key, validate_connection_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/validate_connection.py.html>`__ to see an example of how to use validate_connection API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'dataAssetKey']
    ...
    def validate_pattern(self, catalog_id, pattern_key, validate_pattern_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/datacatalog/validate_pattern.py.html>`__ to see an example of how to use validate_pattern API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogId', 'patternKey']
