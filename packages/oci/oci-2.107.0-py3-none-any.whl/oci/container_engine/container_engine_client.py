...
class ContainerEngineClient(object):
    ...
    def cluster_migrate_to_native_vcn(self, cluster_id, cluster_migrate_to_native_vcn_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/cluster_migrate_to_native_vcn.py.html>`__ to see an example of how to use cluster_migrate_to_native_vcn API.
        """
    ...
    def create_cluster(self, create_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/create_cluster.py.html>`__ to see an example of how to use create_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_kubeconfig(self, cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/create_kubeconfig.py.html>`__ to see an example of how to use create_kubeconfig API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId']
    ...
    def create_node_pool(self, create_node_pool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/create_node_pool.py.html>`__ to see an example of how to use create_node_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_virtual_node_pool(self, create_virtual_node_pool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/create_virtual_node_pool.py.html>`__ to see an example of how to use create_virtual_node_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_workload_mapping(self, cluster_id, create_workload_mapping_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/create_workload_mapping.py.html>`__ to see an example of how to use create_workload_mapping API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId']
    ...
    def delete_cluster(self, cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/delete_cluster.py.html>`__ to see an example of how to use delete_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId']
    ...
    def delete_node(self, node_pool_id, node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/delete_node.py.html>`__ to see an example of how to use delete_node API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_node_pool(self, node_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/delete_node_pool.py.html>`__ to see an example of how to use delete_node_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_virtual_node_pool(self, virtual_node_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/delete_virtual_node_pool.py.html>`__ to see an example of how to use delete_virtual_node_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/delete_work_request.py.html>`__ to see an example of how to use delete_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_workload_mapping(self, cluster_id, workload_mapping_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/delete_workload_mapping.py.html>`__ to see an example of how to use delete_workload_mapping API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def disable_addon(self, cluster_id, addon_name, is_remove_existing_add_on, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/disable_addon.py.html>`__ to see an example of how to use disable_addon API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_addon(self, cluster_id, addon_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/get_addon.py.html>`__ to see an example of how to use get_addon API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_cluster(self, cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/get_cluster.py.html>`__ to see an example of how to use get_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId']
        resource_path = "/clusters/{clusterId}"
    ...
    def get_cluster_migrate_to_native_vcn_status(self, cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/get_cluster_migrate_to_native_vcn_status.py.html>`__ to see an example of how to use get_cluster_migrate_to_native_vcn_status API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId']
    ...
    def get_cluster_options(self, cluster_option_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/get_cluster_options.py.html>`__ to see an example of how to use get_cluster_options API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_node_pool(self, node_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/get_node_pool.py.html>`__ to see an example of how to use get_node_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['nodePoolId']
        resource_path = "/nodePools/{nodePoolId}"
    ...
    def get_node_pool_options(self, node_pool_option_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/get_node_pool_options.py.html>`__ to see an example of how to use get_node_pool_options API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_virtual_node(self, virtual_node_pool_id, virtual_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/get_virtual_node.py.html>`__ to see an example of how to use get_virtual_node API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_virtual_node_pool(self, virtual_node_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/get_virtual_node_pool.py.html>`__ to see an example of how to use get_virtual_node_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['virtualNodePoolId']
        resource_path = "/virtualNodePools/{virtualNodePoolId}"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
    ...
    def get_workload_mapping(self, cluster_id, workload_mapping_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/get_workload_mapping.py.html>`__ to see an example of how to use get_workload_mapping API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId', 'workloadMappingId']
        resource_path = "/clusters/{clusterId}/workloadMappings/{workloadMappingId}"
    ...
    def install_addon(self, cluster_id, install_addon_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/install_addon.py.html>`__ to see an example of how to use install_addon API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId']
    ...
    def list_addon_options(self, kubernetes_version, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/list_addon_options.py.html>`__ to see an example of how to use list_addon_options API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_addons(self, cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/list_addons.py.html>`__ to see an example of how to use list_addons API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId']
        resource_path = "/clusters/{clusterId}/addons"
    ...
    def list_clusters(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/list_clusters.py.html>`__ to see an example of how to use list_clusters API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_node_pools(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/list_node_pools.py.html>`__ to see an example of how to use list_node_pools API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/nodePools"
    ...
    def list_pod_shapes(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/list_pod_shapes.py.html>`__ to see an example of how to use list_pod_shapes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def list_virtual_node_pools(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/list_virtual_node_pools.py.html>`__ to see an example of how to use list_virtual_node_pools API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/virtualNodePools"
    ...
    def list_virtual_nodes(self, virtual_node_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/list_virtual_nodes.py.html>`__ to see an example of how to use list_virtual_nodes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['virtualNodePoolId']
    ...
    def list_work_request_errors(self, compartment_id, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_work_request_logs(self, compartment_id, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId', 'compartmentId']
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def list_workload_mappings(self, cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/list_workload_mappings.py.html>`__ to see an example of how to use list_workload_mappings API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId']
        resource_path = "/clusters/{clusterId}/workloadMappings"
    ...
    def update_addon(self, cluster_id, addon_name, update_addon_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/update_addon.py.html>`__ to see an example of how to use update_addon API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId', 'addonName']
        resource_path = "/clusters/{clusterId}/addons/{addonName}"
    ...
    def update_cluster(self, cluster_id, update_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/update_cluster.py.html>`__ to see an example of how to use update_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId']
        resource_path = "/clusters/{clusterId}"
    ...
    def update_cluster_endpoint_config(self, cluster_id, update_cluster_endpoint_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/update_cluster_endpoint_config.py.html>`__ to see an example of how to use update_cluster_endpoint_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId']
    ...
    def update_node_pool(self, node_pool_id, update_node_pool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/update_node_pool.py.html>`__ to see an example of how to use update_node_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['nodePoolId']
        resource_path = "/nodePools/{nodePoolId}"
    ...
    def update_virtual_node_pool(self, virtual_node_pool_id, update_virtual_node_pool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/update_virtual_node_pool.py.html>`__ to see an example of how to use update_virtual_node_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['virtualNodePoolId']
        resource_path = "/virtualNodePools/{virtualNodePoolId}"
    ...
    def update_workload_mapping(self, cluster_id, workload_mapping_id, update_workload_mapping_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.107.0/containerengine/update_workload_mapping.py.html>`__ to see an example of how to use update_workload_mapping API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId', 'workloadMappingId']
        resource_path = "/clusters/{clusterId}/workloadMappings/{workloadMappingId}"
