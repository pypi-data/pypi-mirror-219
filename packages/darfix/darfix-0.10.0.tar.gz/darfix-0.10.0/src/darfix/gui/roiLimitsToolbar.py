...
class RoiLimitsToolBar(qt.QToolBar):
    ...
    def _initWidgets(self):
        ...
        self._xOriginSpinBox = _createQSpinBox(self, x0, 0, 1000000)
        self._xOriginSpinBox.editingFinished[()].connect(self._handleRoiEditChanged)
        self.addWidget(self._xOriginSpinBox)

        self._yOriginSpinBox = _createQSpinBox(self, y0, 0, 1000000)
        ...
        self._xSizeSpinBox = _createQSpinBox(self, xs, 0, 1000000)
        self._xSizeSpinBox.editingFinished[()].connect(self._handleRoiEditChanged)
        self.addWidget(self._xSizeSpinBox)

        self._ySizeSpinBox = _createQSpinBox(self, ys, 0, 1000000)
    ...
    def _handleRoiPlotChanged(self) -> None:
        ...
        x0, y0 = self.roi.getOrigin()
        xs, ys = self.roi.getSize()
        self._xOriginSpinBox.setValue(x0)
        self._yOriginSpinBox.setValue(y0)
        self._xSizeSpinBox.setValue(xs)
        self._ySizeSpinBox.setValue(ys)
