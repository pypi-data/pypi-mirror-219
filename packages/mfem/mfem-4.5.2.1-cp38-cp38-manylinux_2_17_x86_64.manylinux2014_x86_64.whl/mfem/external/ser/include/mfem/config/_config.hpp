...
#define MFEM_VERSION 40503

// MFEM version string of the form "3.3" or "3.3.1".
#define MFEM_VERSION_STRING "4.5.3"
...
#define MFEM_GIT_STRING "remotes/origin/mfem-4.5.2+tmop-update-combos-181-g962774d5ffa84ceed3bc670e52388250ee028da1"
