...
setup(
    ...
    extras_require={
        "tests": [
            ...
            "dagster_k8s==0.19.14rc2",
        ],
        "docker": ["docker", "dagster_docker==0.19.14rc2"],
        "kubernetes": ["kubernetes", "dagster_k8s==0.19.14rc2"],
        "ecs": ["dagster_aws==0.19.14rc2", "boto3"],
        "sandbox": ["supervisor"],
        "pex": ["boto3"],
        "serverless": ["boto3"],
    },
