...
class Functions(Parameters):
    ENVIROMENT_PROJ_FILE_PATH = os.path.join(os.path.abspath(os.path.join(os.getcwd(), "../..")),
    ...
    def auth(self):
        ...
        self.password_sharepoint = self.Encryptor("CLAVES", "id", "Sharepoint Andreani", "PASS").main()
        self.sharepoint_url = self.Encryptor('CLAVES', 'id', 'Sharepoint Andreani', 'URL').main()
        self.email_pybot = self.Encryptor("CLAVES", "id", "Email de Pybot", "USER").main()
        self.sharepoint_site = self.Encryptor('CLAVES', 'id', 'Sharepoint Andreani', 'SITE').main()
    ...
    def connect_folder(self, folder_name):
        ...
        auth_site = self.auth()
        self.sharepoint_doc=self.Encryptor('CLAVES', 'id', 'Sharepoint Andreani', 'LOCATION').main()
    ...
    def send_mail(self, receiver_email: list, title, content, file_attach=None):
        ...
        """
        self.usuario_pybot_email=self.Encryptor("CLAVES", "id", "Email de Pybot", "USER").main()
        ...
        if Parameters.environment != "Linux":
            ...
            sender_email = self.usuario_pybot_email
            password = self.Encryptor("CLAVES", "id", "Email de Pybot", "PASS").main()
    ...
    @staticmethod
    def check_environment_files(father_attribute, attribute_to_search, data_find, data_inner_key, xml_en_consola=False):
        environment_back_up_file_name = os.path.join(os.path.abspath(os.path.join(os.getcwd(), "../../../..")),
                                                     "environment_access.xml")
        environment_proj_file_path = os.path.join(os.path.abspath(os.path.join(os.getcwd(), "../..")),
                                                  "environment_access.xml")
        encryptor = Encryptor(father_attribute, attribute_to_search, data_find, data_inner_key, ENVIROMENT_VAR,
                              environment_back_up_file_name, environment_proj_file_path, xml_en_consola)
        data = encryptor.main()
        return data
