...
class DWARFDataTypeConflictHandler(ghidra.program.model.data.DataTypeConflictHandler):
    ...
    INSTANCE: ghidra.app.util.bin.format.dwarf4.next.DWARFDataTypeConflictHandler = ghidra.app.util.bin.format.dwarf4.next.DWARFDataTypeConflictHandler@a620e83
