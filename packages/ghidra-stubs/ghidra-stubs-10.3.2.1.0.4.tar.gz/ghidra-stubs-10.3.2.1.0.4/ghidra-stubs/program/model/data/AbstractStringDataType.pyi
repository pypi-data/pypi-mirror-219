...
class AbstractStringDataType(ghidra.program.model.data.BuiltIn, ghidra.program.model.data.Dynamic, ghidra.program.model.data.DataTypeWithCharset):
    ...
    COMMON_STRING_SETTINGS_DEFS: List[ghidra.docking.settings.SettingsDefinition] = array(ghidra.docking.settings.SettingsDefinition, [ghidra.program.model.data.TranslationSettingsDefinition@478f3c4e, ghidra.program.model.data.RenderUnicodeSettingsDefinition@799ebeb8])
    COMMON_WITH_CHARSET_STRING_SETTINGS_DEFS: List[ghidra.docking.settings.SettingsDefinition] = array(ghidra.docking.settings.SettingsDefinition, [ghidra.program.model.data.TranslationSettingsDefinition@478f3c4e, ghidra.program.model.data.RenderUnicodeSettingsDefinition@799ebeb8, ghidra.program.model.data.CharsetSettingsDefinition@6f1a8291])
