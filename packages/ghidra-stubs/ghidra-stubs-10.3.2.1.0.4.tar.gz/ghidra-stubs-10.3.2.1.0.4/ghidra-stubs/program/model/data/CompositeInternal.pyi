...
class CompositeInternal(ghidra.program.model.data.Composite, object):
    ...
    class ComponentComparator(object, java.util.Comparator):
        INSTANCE: ghidra.program.model.data.CompositeInternal.ComponentComparator = ghidra.program.model.data.CompositeInternal$ComponentComparator@6069c6ac
    ...
    class OffsetComparator(object, java.util.Comparator):
        INSTANCE: ghidra.program.model.data.CompositeInternal.OffsetComparator = ghidra.program.model.data.CompositeInternal$OffsetComparator@1816e3e2
    ...
    class OrdinalComparator(object, java.util.Comparator):
        INSTANCE: ghidra.program.model.data.CompositeInternal.OrdinalComparator = ghidra.program.model.data.CompositeInternal$OrdinalComparator@22e4931a
