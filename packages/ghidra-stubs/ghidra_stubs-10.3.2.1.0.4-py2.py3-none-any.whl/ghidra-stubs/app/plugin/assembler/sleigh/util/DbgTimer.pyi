...
class DbgTimer(java.io.PrintStream):
    ...
    ACTIVE: ghidra.app.plugin.assembler.sleigh.util.DbgTimer = ghidra.app.plugin.assembler.sleigh.util.DbgTimer@3024c209
    INACTIVE: ghidra.app.plugin.assembler.sleigh.util.DbgTimer = ghidra.app.plugin.assembler.sleigh.util.DbgTimer$2@24e1b79f
