...
class EndianSettingsDefinition(object, ghidra.docking.settings.EnumSettingsDefinition):
    ...
    BIG: int = 2
    DEF: ghidra.program.model.data.EndianSettingsDefinition = ghidra.program.model.data.EndianSettingsDefinition@2fece060
    DEFAULT: int = 0
    ENDIAN: ghidra.program.model.data.EndianSettingsDefinition = ghidra.program.model.data.EndianSettingsDefinition@2fece060
    LITTLE: int = 1
