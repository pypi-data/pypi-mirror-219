...
class CycleGroup(object):
    ...
    ALL_CYCLE_GROUPS: List[object] = [ghidra.program.model.data.CycleGroup$ByteCycleGroup@3008a279, ghidra.program.model.data.CycleGroup$FloatCycleGroup@127c8786, ghidra.program.model.data.CycleGroup$StringCycleGroup@67a81a4d]
    BYTE_CYCLE_GROUP: ghidra.program.model.data.CycleGroup = ghidra.program.model.data.CycleGroup$ByteCycleGroup@3008a279
    FLOAT_CYCLE_GROUP: ghidra.program.model.data.CycleGroup = ghidra.program.model.data.CycleGroup$FloatCycleGroup@127c8786
    STRING_CYCLE_GROUP: ghidra.program.model.data.CycleGroup = ghidra.program.model.data.CycleGroup$StringCycleGroup@67a81a4d
