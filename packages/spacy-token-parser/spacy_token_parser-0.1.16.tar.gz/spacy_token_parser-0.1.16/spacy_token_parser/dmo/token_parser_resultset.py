...
from bast_ai.base import BastObject


class TokenParserResultSet(BastObject):
    """ Add Wordnet Flag to Token """
    ...
    def __init__(self):
        ...
        Updated:
            ...
            *   Ensure Unique Token ID and HEAD values
                https://github.com/craigtrim/spacy-token-parser/issues/7
                [
                    https://bast-ai.atlassian.net/browse/COR-134
                ]
        """
        BastObject.__init__(self, __name__)
