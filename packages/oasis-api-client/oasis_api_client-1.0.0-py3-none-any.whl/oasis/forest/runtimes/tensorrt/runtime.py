...
from oasis.forest.core.runtime import AbstractRuntimeImplementation
...
class TensorRTRuntime(AbstractRuntimeImplementation):
    ...
    def bind_input(self, input, object):
        ...
        from oasis.forest.runtimes.tensorrt.utils import HostDeviceMem
    ...
    def bind_all_inputs(self):
        from oasis.forest.runtimes.tensorrt.utils import allocate_buffers
