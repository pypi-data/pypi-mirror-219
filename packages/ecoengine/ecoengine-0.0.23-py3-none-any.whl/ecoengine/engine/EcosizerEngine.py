...
class EcosizerEngine:
    ...
    def getSimRunWithkWCalc(self, initPV=None, initST=None, minuteIntervals = 1, nDays = 3, optimizeNLS = False):
        ...
        kGperkWh_saved = kGperkWh_nls - kGperkWh_ls
        print('ls kg_sum is', simRun_ls.getkGCO2perkWhSum())
        print('kg_sum is', simRun_nls.getkGCO2perkWhSum())
        print('denom',loadshift_capacity)
        print("LS kGperkWh", kGperkWh_ls)
        print("non-LS kGperkWh", kGperkWh_nls)
        print("LS to non-LS diff:", kGperkWh_saved)
