...
from pytermor import Fragment, NOOP_COLOR, Style, center_sgr, distribute_padded, flatten
...
class TmuxFormatter(Formatter):
    def print_extras(self):
        ...
        pref = self._bind_collectors[0].get_invoker("prefix")
        pref_compat = self._bind_collectors[0].get_invoker("compat")

        kcfact = KeyComboFactory(self._bind_collectors[0].is_invoker)
