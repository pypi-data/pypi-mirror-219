...
class Interpolator2D():
    ...
    def __init__(self,
        ...
        self.origin = center_point(lats, lons) if origin is None else origin

        self.logger.debug(f"Origin for XY coordinate system set to (lat,lon) = {self.origin}")
    ...
    def interp_xy(self, x, y, grid=False, x_deriv_order=0, y_deriv_order=0, origin=None):
        ...
        """
        self.logger.log(level=1, msg=f"Interpolating at x={x} and y={y} relative to (lat,lon)={self.origin} with grid={grid}")
    ...
    def interp(self,
        ...
        """
        self.logger.log(level=1, msg=f"Interpolating at lat={lat} and lat={lon}")
...
class Interpolator3D():
    ...
    def __init__(self,
        ...
        self.logger.debug(f"Origin of XY coordinate system set to (lat,lon) = {self.origin}")
    ...
    def interp_xy(self, x, y, z, grid=False, origin=None):
        """ Interpolate using planar coordinate system (xy).
