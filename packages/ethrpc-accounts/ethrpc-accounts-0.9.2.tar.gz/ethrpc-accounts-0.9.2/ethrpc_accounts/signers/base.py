...
class BaseAccount(ABC):
    ...
    def sign_message(self, signable_message: SignableMessage) -> SignedMessage:
        ...
        as in :meth:`~ethrpc_accounts.account.Account.sign_message`
    ...
    def signHash(self, message_hash):
        ...
        This uses the same structure
        as in :meth:`~ethrpc_accounts.account.Account.signHash`
        but without specifying the private key.

        .. CAUTION:: Deprecated for
            :meth:`~ethrpc_accounts.signers.base.BaseAccount.sign_message`.
    ...
    def signTransaction(self, transaction_dict):
        ...
        :meth:`~ethrpc_accounts.account.Account.sign_transaction`
        but without specifying the private key.

        .. CAUTION:: Deprecated for
            :meth:`~ethrpc_accounts.account.signers.local.sign_transaction`.
