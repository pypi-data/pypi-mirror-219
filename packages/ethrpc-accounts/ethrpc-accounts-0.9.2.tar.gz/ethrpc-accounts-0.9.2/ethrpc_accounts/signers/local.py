...
from ethrpc_accounts.signers.base import (
    BaseAccount,
)
...
class LocalAccount(BaseAccount):
    ...
    def __init__(self, key, account):
        ...
        :param ethrpc_keys.PrivateKey key: to prefill in private key execution
        :param ~ethrpc_accounts.account.Account account: the key-unaware management API
        """
    ...
    def encrypt(self, password, kdf=None, iterations=None):
        ...
        :meth:`~ethrpc_accounts.account.Account.encrypt`, but without a
    ...
    def sign_message(self, signable_message):
        ...
        This uses the same structure as in
        :meth:`~ethrpc_accounts.account.Account.sign_message`, but without a
        private key argument.
        """
