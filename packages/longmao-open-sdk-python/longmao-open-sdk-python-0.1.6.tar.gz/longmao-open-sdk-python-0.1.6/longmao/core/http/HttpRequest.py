...
from longmao.core.utils.Constants import *
...
from longmao.core.http.FileItem import FileItem
from longmao.core.exception.Exception import *
...
class MultiPartForm(object):
    ...
    def __init__(self, charset='utf-8'):
        ...
        self.form_fields = []
        self.files = []
        self.boundary = "LONGMAO_OPEN_SDK_PYTHON_BOUNDARY"
        return
