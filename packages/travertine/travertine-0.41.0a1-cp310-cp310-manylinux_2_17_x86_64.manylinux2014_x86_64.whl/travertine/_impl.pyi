...
class Program:
    ...
    def add_formula_procedure(
        self, index: ProcedureIndex, code: str, procedures: t.Sequence[ProcedureIndex]
    ) -> None: ...
    ...
    def add_setenv_procedure(
        self, index: ProcedureIndex, env: t.Mapping[str, float], proc: ProcedureIndex
    ) -> None: ...
    ...
    def execute_many(
        self, demand: t.Sequence[UnitaryDemand], undefined: Result
    ) -> t.Sequence[Result]: ...
