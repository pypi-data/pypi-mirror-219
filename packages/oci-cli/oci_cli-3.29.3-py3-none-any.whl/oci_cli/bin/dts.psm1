...
function GetOciSubcommands_dts() {
    $ociSubcommands = @{
        ...
        'dts appliance' = 'cancel delete get-passphrase list never-receive request request-entitlement setup-notifications show show-entitlement update-minimum-storage-capacity update-shipping-address'
