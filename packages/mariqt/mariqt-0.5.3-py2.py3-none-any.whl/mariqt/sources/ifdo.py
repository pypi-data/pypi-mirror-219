    ...
    def readiFDOfile(self,file:str):
        ...
        try:
            if not self.ignore_image_files:
                ...
                self.updateiFDO(self.ifdo_tmp[self.imageSetHeaderKey], miqti.createImageItemsListFromImageItemsDict(self.ifdo_tmp[self.imageSetItemsKey]),headerOnly=self.ignore_image_files)
        except Exception as ex:
