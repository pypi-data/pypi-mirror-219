...
from langchain_sql_test.prompt import DECIDER_PROMPT, PROMPT, QUERY_CHECKER, SQL_PROMPTS
...
class SQLDatabaseChain(Chain):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_sql import SQLDatabaseChain, SQLDatabase
    ...
    llm_chain: LLMChain
    """LLM Chain used for constructing SQL queries."""
    ...
    def raise_deprecation(cls, values: Dict) -> Dict:
        if "llm" in values:
            ...
            if "llm_chain" not in values and values["llm"] is not None:
                ...
                prompt = values.pop("prompt", None) or SQL_PROMPTS.get(
                    database.dialect, PROMPT
                )
                values["llm_chain"] = LLMChain(llm=values.pop("llm"), prompt=prompt)
        return values
