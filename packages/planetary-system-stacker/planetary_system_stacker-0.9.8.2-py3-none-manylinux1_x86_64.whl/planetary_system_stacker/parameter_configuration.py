...
class Ui_ConfigurationDialog(object):
    def setupUi(self, ConfigurationDialog):
        ...
        ConfigurationDialog.resize(1054, 608)
        font = QtGui.QFont()
        ...
        self.GridLayout.addWidget(self.restore_standard_values, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.nfs_checkBox, 7, 5, 1, 2)
        self.mr_checkBox = QtWidgets.QCheckBox(self.tab_workflow)
        self.mr_checkBox.setObjectName("mr_checkBox")
        self.gridLayout.addWidget(self.mr_checkBox, 16, 1, 1, 1)
        self.spp_checkBox = QtWidgets.QCheckBox(self.tab_workflow)
        self.spp_checkBox.setObjectName("spp_checkBox")
        self.gridLayout.addWidget(self.spp_checkBox, 18, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.gpbl_combobox, 12, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.gpbl_label_parameter, 12, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.gppl_label_parameter, 1, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.gpif_label_parameter, 3, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.gpwptf_checkBox, 1, 1, 1, 1)
        spacerItem7 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem7, 1, 7, 1, 1)
        self.mr_label = QtWidgets.QLabel(self.tab_workflow)
        self.mr_label.setText("")
        self.mr_label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.mr_label.setWordWrap(True)
        self.mr_label.setObjectName("mr_label")
        self.gridLayout.addWidget(self.mr_label, 12, 4, 7, 4)
    ...
    def retranslateUi(self, ConfigurationDialog):
        ...
        self.mr_checkBox.setText(_translate("ConfigurationDialog", "Maximum RAM (GBytes)"))
