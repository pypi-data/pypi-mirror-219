...
application/pyrogramlink+xml			pyrogramlink
application/pyrogramlink4+xml			pyrogram4
...
# application/samlpyrogramdata+xml
...
# application/vnd.openxmlformats-officedocument.spreadsheetml.sheetpyrogramdata+xml
...
application/x-mspyrogramfile			wmf wmz emf emz
