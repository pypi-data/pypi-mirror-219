"""This module features the StreamlinedInference class, that extends the Inference interface,
and can be used to run end-to-end inference on a wrapped Inference subclass.
"""
import logging
...
class StreamlinedInference(Inference):
    ...
    Attributes:
        ...
        - data_validator: A DataValidator instance that is used to validate the input data.
        - preprocessor: A Preprocessor instance that is used to preprocess the input data.
    ...
    def _predict(self, input_data: InferenceData) -> InferenceData:
        ...
        numpy array or a dictionary of numpy arrays. It is important to note that in
        the case of TorchInference numpy array(s) should be of type float32.
