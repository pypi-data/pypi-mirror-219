...
class AbstractFactory(ABC):
    """This class provides an interface for creating families of related objects without specifying
    their concrete classes.

    Attributes:
    - subclass_creators: An abstract property that holds a dictionary with keys corresponding
    to subclass names and values corresponding to the subclass creator functions.
    ...
    def subclass_creators(self) -> dict:
        """Returns a dictionary with keys corresponding to subclass names and values corresponding
        to the subclass creator functions."""
    ...
    def create(self, subclass_type: str, **kwargs) -> Any:
        ...
        :param kwargs: The keyword arguments to be passed to the subclass creator function.
