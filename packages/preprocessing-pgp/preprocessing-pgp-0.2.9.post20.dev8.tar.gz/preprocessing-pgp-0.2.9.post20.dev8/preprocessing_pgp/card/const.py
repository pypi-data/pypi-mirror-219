...
__OLD_PID_CODE_PATH = f"{CURRENT_PATH}/../old_codes.parquet"
__NEW_PID_CODE_PATH = f"{CURRENT_PATH}/../new_codes.parquet"
__REGION_PID_CODE_PATH = f"{CURRENT_PATH}/../new_region_code.parquet"
