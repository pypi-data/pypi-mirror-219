...
class EZooError(Exception):
    """Exception related to operation with MySQL."""


class Warning(Warning, EZooError):
    """Exception raised for important warnings like data truncations
    while inserting, etc."""


class Error(EZooError):
...
class ParserSchemeError(DatabaseError):
    """Exception raised when parse input scheme url"""


class ParamCheckError(DatabaseError):
    """input params invalid"""


class FindLeaderError(DatabaseError):
    """can not find a leader when use pooled distribute"""


class ConnectError(DatabaseError):
