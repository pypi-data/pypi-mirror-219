...
from dql.error import DatasetNotFoundError, QueryScriptCompileError, QueryScriptRunError
...
def test_query_with_pre_created_dataset(cloud_test_catalog, mock_subprocess_run):
    catalog = cloud_test_catalog.catalog
    src_uri = cloud_test_catalog.src_uri
    dataset_name = "pre_created_dataset"
    pre_created_ds = catalog.create_shadow_dataset(dataset_name, [], populate=False)
...
def test_query_fail_to_compile_pre_created_dataset(cloud_test_catalog):
    catalog = cloud_test_catalog.catalog
    dataset_name = "pre_created_dataset"
    pre_created_ds = catalog.create_shadow_dataset(dataset_name, [], populate=False)
    ...
    pre_created_ds = catalog.get_dataset("pre_created_dataset")
...
def test_query_subprocess_dataset_not_returned(
