...
do
    ...
    sleep 5
    python contact_diffs.py -i $directory/$name/$filename.H3static_contacts.csv -r $reference.static_contacts.csv -o $directory/$name/$filename.H3contactdiffs.static.csv
    sleep 5
    ...
    sed '1i zero,bond_type,chain1,chain2' $directory/$name/$filename.H3SsiteE.csv
done
