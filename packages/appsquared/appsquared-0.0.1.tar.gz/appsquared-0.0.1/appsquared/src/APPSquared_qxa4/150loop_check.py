...
def compare_files(test_file):
    with open(test_file) as parsed_file:
        ...
        for line in parsed_file:
            match = re.search(r'141|142|143|144|145|146|147|148|149|150',line)
            #rbs = [98|134|135|136|137|138|153|155|183|190|194|221|222|223|224|225|226|227|228]
            #for i in rbs:
                #if item in parsed_file.read():
            if match:
                print(line)
                _150loop_sites.append(line)
    return _150loop_sites

_150loop_adj = compare_files(args.input)
#print(rbs_adj)
diff_df = pd.DataFrame(_150loop_adj)
