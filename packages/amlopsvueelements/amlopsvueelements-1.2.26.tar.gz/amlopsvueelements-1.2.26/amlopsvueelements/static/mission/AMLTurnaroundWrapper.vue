              ...
              >
                ...
                >
                  <div class="flex items-center justify-between w-full mt-2">
                    <div class="flex items-center shrink-0 whitespace-nowrap h-[22px] last:!mb-0">
                      <div class="flex w-full min-w-[10rem]">
                        <img
                    ...
                    <div
                      ...
                      class="border-b mb-1 border-dashed border-grey-opacity-800/25 h-1 w-full mx-5"
                    />
