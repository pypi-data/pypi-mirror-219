            ...
            <div class="flex flex-col items-center w-full">
                ...
                <div class="flex w-full items-center justify-between mb-4">
                  ...
                  <div class="flex mr-2">
                    <div
                      ...
                      class="flex gap-x-[1.6rem] justify-between font-normal text-base items-center"
                    >
                      <span>Arr</span>
                      <span>Dep</span>
                    </div>
              ...
              >
                <div
                  ...
                  :key="service.id"
                  class="w-full last:!border-none mb-2 last:mb-0"
                >
                  <div class="flex items-center justify-between w-full">
                    <div class="flex items-center shrink-0 whitespace-nowrap h-[22px]">
                      <div
                        ...
                        :class="{
                          'min-w-[10rem]':
                            service.is_allowed_quantity_selection || service.is_allowed_free_text
                        }"
                      >
                        <img
...
.ops-aml-turnaround {
  ...
  &__content {
    ...
    .free-input {
      @apply mx-5 pl-2 leading-6 w-full h-fit overflow-hidden flex items-center appearance-none text-[0.875rem] bg-clip-padding  bg-white font-normal focus:outline-none text-grey-700 border-grey-100 border-[0.0625rem] border-solid rounded-[0.5rem] #{!important};
