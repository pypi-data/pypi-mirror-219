...
class BaseScript:
    ...
    def init_logger(self):
        ...
        logger.remove()
        logger.add(sink=sys.stderr, level=logging_level, format=settings.get('logging.format.verbose'))
        logger.add(sink=sink, level=logging_level, format=settings.get('logging.format.verbose'))
...
class Manager:
    ...
    def init_logger(self):
        ...
        logger.remove()
        logger.add(sys.stderr, format=settings.get('logging.format.verbose'))
