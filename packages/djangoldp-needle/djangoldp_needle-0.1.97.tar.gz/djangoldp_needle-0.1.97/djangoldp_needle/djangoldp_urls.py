...
from .views import AnnotationViewset, AnnotationTargetViewset, TagViewset, AnnotationIntersectionReadViewset, \
    ...
    NeedleUserContactPendingViewset, BookletContributorPendingViewset
from .views.booklet_contributor import BookletContributorViewset
...
urlpatterns = [
    ...
    url(r'^needleusercontact/', NeedleUserContactViewset.urls(model=NeedleUserContact)),
