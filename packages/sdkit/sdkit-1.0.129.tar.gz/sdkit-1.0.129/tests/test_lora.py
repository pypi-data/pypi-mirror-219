...
def test_lora():
    context.model_paths["stable-diffusion"] = "models/stable-diffusion/dreamshaper_631BakedVae.safetensors"
    load_model(context, "stable-diffusion")

    context.model_paths["lora"] = "models/lora/WH40KSisters_V2rank8.safetensors"
    # context.model_paths["lora"] = "models/lora/EbonyGoldAI.safetensors"
    load_model(context, "lora")

    context.model_paths["vae"] = "models/vae/vae-ft-mse-840000-ema-pruned.ckpt"
    load_model(context, "vae")

    # model = context.models["stable-diffusion"]["default"]
    # model.load_lora_weights("models/lora/WH40KSisters_V2rank8.safetensors")

    images = generate_images(
        context,
        prompt="4k photo, realistic, masterpiece, absurdres, warhammer 40k, woman with white hair in black armor, adepta sororitas, snowy background",
        negative_prompt="ugly, child, baby, old, extra limbs, extra legs, lazy eye, cross eyed, multiple navels, three legs, three arms, bra, three feet, extra feet, bad anatomy, deformed, mutated",
        width=768,
        height=768,
        seed=3779111385,
