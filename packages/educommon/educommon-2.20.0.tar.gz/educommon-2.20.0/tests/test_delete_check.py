...
from tests.delete_check.actions import DeleteCheckPack
from tests.delete_check.models import DeleteCheckModel1
from tests.delete_check.models import DeleteCheckModel2
from tests.delete_check.models import DeleteCheckModel3
from tests.delete_check.models import DeleteCheckModel4
...
class DeleteCheckListenerTestCase(TestCase):
    ...
    u"""Тесты для примесей слушателя DeleteCheck."""
    ...
    def test__cascade_delete_mixin(self):
        u"""Проверка работоспособности CascadeDeleteMixin."""
    ...
    def test__cascade_delete_pack_mixin(self):
        u"""Проверка работоспособности CascadeDeletePackMixin."""
        obj1 = DeleteCheckModel1.objects.create()
