...
from tests.testapp import models as test_models
...
class TestPersonalDataFields(TestCase):
    ...
    def test_names(self):
        ...
        valid_names = (
            (u'Майор', u'Майор', u'Майор'),
            (u'Майор', u'Майор', u'Майор Майор'),
            (u'Major', u'Major', u'Major'),
            (u'Major', u'Major', None),
            (u'Майор', u'Майор-Major', None),
            (u'Майор-Major', u'Майор-Major', u'Майор-Major', ),
            (u'Майор Major', u'Майор Major', u'Майор Major', ),
        )
        invalid_names = (
            (u'Major!', u'Major!', None),
            ...
            (u'Major)', u'Major)', None),
            (u'Major*', u'Major*', None),
            (u'Major_', u'Major_', None),
            (u'Major+', u'Major+', None),
            (u'Major!', u'Major!', None),
            (u'Major  Major', u'Major  Major', None),
            (u'Major--Major', u'Major--Major', None),
        )
    ...
    def test_snils(self):
        ...
        invalid_snilses = (
            (u'12312345601', ),  # нет разделителей
            (u'123-123-456 02', ),  # неверная контрольная сумма
            (u'd23-123-456 02', ),  # неверный символ
            (u'123-d23-456 02', ),  # неверный символ
            (u'123-123-d56 02', ),  # неверный символ
            (u'123-123-456 d2', ),  # неверный символ
        )
    ...
    def test_documents_with_series_and_number(self):
        ...
        valid_documents = (
            (u'123abc', u'456def', u'0110', u'102030'),
        )
        invalid_documents = (
            (u'a' * 11, u'456def', u'0110', u'102030'),
            (u'a', u'4' * 21, u'0110', u'102030'),
            (u'a', u'456def', u'01101', u'102030'),
            (u'a', u'456def', u'0', u'102030'),
            (u'a', u'456def', u'0110', u'1020301'),
            (u'a', u'456def', u'0110', u'1'),
            (u'a', u'456def', u'd110', u'102030'),
            (u'a', u'456def', u'0110', u'd02030'),
        )
    ...
    def test_ogranization_documents(self):
        ...
        # ИНН, КПП, ОГРН
        valid_values = (
            (u'1655251590', u'165501001', u'1121690063923'),
        )
        invalid_values = (
            (u'500100732200', u'16550100d', u'11216900639a'),
            (u'500100732200', u'16550100', u'112169006393'),
        )
    ...
    def _test_valid_invalid(self, model, valid_values, invalid_values):
        u"""Проверяет, что определенные значения могут быть добавлены в модель,
    ...
    def _test_linear_regex(self, model, valid_values):
        u"""Тестирует, что валидное значение будет введено от начала до конца
    ...
    def _simulate_input(value):
        u"""Симулирует линейный ввод значения в текстовое поле
