...
class Ec2InstanceRunningScheduler(
    ...
    jsii_type="aws-ec2-instance-running-scheduler.Ec2InstanceRunningScheduler",
):
    def __init__(
        self,
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ea36af992668707fef46a9ad5513347d5bc738800e6243a3b6989c400c2e6837)
...
@jsii.data_type(
    jsii_type="aws-ec2-instance-running-scheduler.Ec2InstanceRunningSchedulerProps",
    jsii_struct_bases=[],
...
class Ec2InstanceRunningSchedulerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__09933ee5e9092dff6fcd83c404089aa558ccdb470d5d665b9909864f4119d0ab)
...
@jsii.data_type(
    jsii_type="aws-ec2-instance-running-scheduler.ScheduleProperty",
    jsii_struct_bases=[],
    name_mapping={
        "timezone": "timezone",
        "hour": "hour",
...
class ScheduleProperty:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fb27c35485ae6dae3f078eaa6b51e3257f6a324d2703a3740d410b98a74d987c)
...
@jsii.data_type(
    jsii_type="aws-ec2-instance-running-scheduler.TargetsProperty",
    jsii_struct_bases=[],
    name_mapping={
        "instances": "instances",
...
class TargetsProperty:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__51555a2f265186d65bd760306636087f8cf8b0c4e020952b0348ef2b84a34dfb)
...
def _typecheckingstub__ea36af992668707fef46a9ad5513347d5bc738800e6243a3b6989c400c2e6837(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    targets: typing.Sequence[typing.Union[TargetsProperty, typing.Dict[builtins.str, typing.Any]]],
...
def _typecheckingstub__09933ee5e9092dff6fcd83c404089aa558ccdb470d5d665b9909864f4119d0ab(
    *,
    targets: typing.Sequence[typing.Union[TargetsProperty, typing.Dict[builtins.str, typing.Any]]],
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__fb27c35485ae6dae3f078eaa6b51e3257f6a324d2703a3740d410b98a74d987c(
    *,
    timezone: builtins.str,
    hour: typing.Optional[builtins.str] = None,
    minute: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__51555a2f265186d65bd760306636087f8cf8b0c4e020952b0348ef2b84a34dfb(
    *,
    instances: typing.Sequence[builtins.str],
    start_schedule: typing.Union[ScheduleProperty, typing.Dict[builtins.str, typing.Any]],
    stop_schedule: typing.Union[ScheduleProperty, typing.Dict[builtins.str, typing.Any]],
