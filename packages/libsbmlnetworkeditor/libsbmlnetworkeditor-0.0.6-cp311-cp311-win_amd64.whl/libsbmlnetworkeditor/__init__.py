...
def createDefaultLayoutAndRenderFeatures(document):
    return _libsbmlnetworkeditor.createDefaultLayoutAndRenderFeatures(document)
...
def getCompartment(*args):
    return _libsbmlnetworkeditor.getCompartment(*args)
